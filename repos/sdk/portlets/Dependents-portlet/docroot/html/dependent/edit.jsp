...
Dependent j = (Dependent)rslt.getObject();

String prk=String.valueOf(j.getPrimaryKey());
%>
<liferay-ui:icon-menu>
<portlet:actionURL var="editdependent" name="editDependent">
<portlet:param name="dependentId" value="<%=prk %>"/>
</portlet:actionURL>


<a href="#" onclick="window.location='<%=editdependent.toString()%>'"><img
