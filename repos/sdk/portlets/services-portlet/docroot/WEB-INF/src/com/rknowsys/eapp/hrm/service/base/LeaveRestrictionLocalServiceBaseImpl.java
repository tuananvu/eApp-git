...
import com.rknowsys.eapp.hrm.service.LeaveRestrictionLocalService;
...
/**
 * Provides the base implementation for the leave restriction local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LeaveRestrictionLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class LeaveRestrictionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveRestrictionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LeaveRestrictionLocalServiceUtil} to access the leave restriction local service.
	 */
	...
	@Override
	public LeaveRestriction addLeaveRestriction(
		LeaveRestriction leaveRestriction) throws SystemException {
		leaveRestriction.setNew(true);

		return leaveRestrictionPersistence.update(leaveRestriction);
	}
	 ...
	 */
	@Override
	public LeaveRestriction createLeaveRestriction(long leaveRestrictionId) {
		return leaveRestrictionPersistence.create(leaveRestrictionId);
	}
	...
	@Override
	public LeaveRestriction deleteLeaveRestriction(long leaveRestrictionId)
		throws PortalException, SystemException {
		return leaveRestrictionPersistence.remove(leaveRestrictionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveRestriction deleteLeaveRestriction(
		LeaveRestriction leaveRestriction) throws SystemException {
		return leaveRestrictionPersistence.remove(leaveRestriction);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveRestriction.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return leaveRestrictionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveRestrictionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveRestriction fetchLeaveRestriction(long leaveRestrictionId)
		throws SystemException {
		return leaveRestrictionPersistence.fetchByPrimaryKey(leaveRestrictionId);
	}
	 ...
	 */
	@Override
	public LeaveRestriction getLeaveRestriction(long leaveRestrictionId)
		throws PortalException, SystemException {
		return leaveRestrictionPersistence.findByPrimaryKey(leaveRestrictionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return leaveRestrictionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveRestriction> getLeaveRestrictions(int start, int end)
		throws SystemException {
		return leaveRestrictionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveRestrictionsCount() throws SystemException {
		return leaveRestrictionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveRestriction updateLeaveRestriction(
		LeaveRestriction leaveRestriction) throws SystemException {
		return leaveRestrictionPersistence.update(leaveRestriction);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.LeaveRestriction",
			leaveRestrictionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveRestrictionPersistence.getDataSource();
	...
	private LeaveRestrictionLocalServiceClpInvoker _clpInvoker = new LeaveRestrictionLocalServiceClpInvoker();
}