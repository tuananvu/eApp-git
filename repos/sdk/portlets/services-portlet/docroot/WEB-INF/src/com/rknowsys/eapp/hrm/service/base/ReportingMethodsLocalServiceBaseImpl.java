...
import com.rknowsys.eapp.hrm.service.ReportingMethodsLocalService;
...
/**
 * Provides the base implementation for the reporting methods local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.ReportingMethodsLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.ReportingMethodsLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.ReportingMethodsLocalServiceUtil
 * @generated
 */
public abstract class ReportingMethodsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ReportingMethodsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.ReportingMethodsLocalServiceUtil} to access the reporting methods local service.
	 */

	/**
	 * Adds the reporting methods to the database. Also notifies the appropriate model listeners.
	 *
	 * @param reportingMethods the reporting methods
	 * @return the reporting methods that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ReportingMethods addReportingMethods(
		ReportingMethods reportingMethods) throws SystemException {
		reportingMethods.setNew(true);

		return reportingMethodsPersistence.update(reportingMethods);
	}
	 ...
	 */
	@Override
	public ReportingMethods createReportingMethods(long reportingmethodId) {
		return reportingMethodsPersistence.create(reportingmethodId);
	}

	/**
	 * Deletes the reporting methods with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param reportingmethodId the primary key of the reporting methods
	 * @return the reporting methods that was removed
	 * @throws PortalException if a reporting methods with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ReportingMethods deleteReportingMethods(long reportingmethodId)
		throws PortalException, SystemException {
		return reportingMethodsPersistence.remove(reportingmethodId);
	}

	/**
	 * Deletes the reporting methods from the database. Also notifies the appropriate model listeners.
	 *
	 * @param reportingMethods the reporting methods
	 * @return the reporting methods that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ReportingMethods deleteReportingMethods(
		ReportingMethods reportingMethods) throws SystemException {
		return reportingMethodsPersistence.remove(reportingMethods);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ReportingMethods.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return reportingMethodsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return reportingMethodsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ReportingMethods fetchReportingMethods(long reportingmethodId)
		throws SystemException {
		return reportingMethodsPersistence.fetchByPrimaryKey(reportingmethodId);
	}

	/**
	 * Returns the reporting methods with the primary key.
	 *
	 * @param reportingmethodId the primary key of the reporting methods
	 ...
	 */
	@Override
	public ReportingMethods getReportingMethods(long reportingmethodId)
		throws PortalException, SystemException {
		return reportingMethodsPersistence.findByPrimaryKey(reportingmethodId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return reportingMethodsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ReportingMethods> getReportingMethodses(int start, int end)
		throws SystemException {
		return reportingMethodsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getReportingMethodsesCount() throws SystemException {
		return reportingMethodsPersistence.countAll();
	}

	/**
	 * Updates the reporting methods in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param reportingMethods the reporting methods
	 * @return the reporting methods that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ReportingMethods updateReportingMethods(
		ReportingMethods reportingMethods) throws SystemException {
		return reportingMethodsPersistence.update(reportingMethods);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.ReportingMethods",
			reportingMethodsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.ReportingMethods");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = reportingMethodsPersistence.getDataSource();
	...
	private ReportingMethodsLocalServiceClpInvoker _clpInvoker = new ReportingMethodsLocalServiceClpInvoker();
}