...
import com.rknowsys.eapp.hrm.service.EmpWorkExpLocalService;
...
/**
 * Provides the base implementation for the EmpWorkExp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpWorkExpLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpWorkExpLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpWorkExpLocalServiceUtil
 * @generated
 */
public abstract class EmpWorkExpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpWorkExpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpWorkExpLocalServiceUtil} to access the EmpWorkExp local service.
	 */
	...
	@Override
	public EmpWorkExp addEmpWorkExp(EmpWorkExp empWorkExp)
		throws SystemException {
		empWorkExp.setNew(true);

		return empWorkExpPersistence.update(empWorkExp);
	}
	 ...
	 */
	@Override
	public EmpWorkExp createEmpWorkExp(long empWorkExpId) {
		return empWorkExpPersistence.create(empWorkExpId);
	}
	...
	@Override
	public EmpWorkExp deleteEmpWorkExp(long empWorkExpId)
		throws PortalException, SystemException {
		return empWorkExpPersistence.remove(empWorkExpId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpWorkExp deleteEmpWorkExp(EmpWorkExp empWorkExp)
		throws SystemException {
		return empWorkExpPersistence.remove(empWorkExp);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpWorkExp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empWorkExpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return empWorkExpPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empWorkExpPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpWorkExp fetchEmpWorkExp(long empWorkExpId)
		throws SystemException {
		return empWorkExpPersistence.fetchByPrimaryKey(empWorkExpId);
	}
	 ...
	 */
	@Override
	public EmpWorkExp getEmpWorkExp(long empWorkExpId)
		throws PortalException, SystemException {
		return empWorkExpPersistence.findByPrimaryKey(empWorkExpId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empWorkExpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpWorkExp> getEmpWorkExps(int start, int end)
		throws SystemException {
		return empWorkExpPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpWorkExpsCount() throws SystemException {
		return empWorkExpPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpWorkExp updateEmpWorkExp(EmpWorkExp empWorkExp)
		throws SystemException {
		return empWorkExpPersistence.update(empWorkExp);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpWorkExp",
			empWorkExpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpWorkExp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empWorkExpPersistence.getDataSource();
	...
	private EmpWorkExpLocalServiceClpInvoker _clpInvoker = new EmpWorkExpLocalServiceClpInvoker();
}