...
import com.rknowsys.eapp.hrm.service.DocCategoryLocalService;
...
/**
 * Provides the base implementation for the doc category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.DocCategoryLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.DocCategoryLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.DocCategoryLocalServiceUtil
 * @generated
 */
public abstract class DocCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.DocCategoryLocalServiceUtil} to access the doc category local service.
	 */

	/**
	 * Adds the doc category to the database. Also notifies the appropriate model listeners.
	 *
	 * @param docCategory the doc category
	 * @return the doc category that was added
	...
	public DocCategory addDocCategory(DocCategory docCategory)
		...
		return docCategoryPersistence.update(docCategory);
	}
	...
	/**
	 * Deletes the doc category from the database. Also notifies the appropriate model listeners.
	 *
	 * @param docCategory the doc category
	 * @return the doc category that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DocCategory deleteDocCategory(DocCategory docCategory)
		throws SystemException {
		return docCategoryPersistence.remove(docCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return docCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return docCategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return docCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return docCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocCategory> getDocCategories(int start, int end)
		throws SystemException {
		return docCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDocCategoriesCount() throws SystemException {
		return docCategoryPersistence.countAll();
	}

	/**
	 * Updates the doc category in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param docCategory the doc category
	 * @return the doc category that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.DocCategory",
			docCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.DocCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = docCategoryPersistence.getDataSource();
	...
	private DocCategoryLocalServiceClpInvoker _clpInvoker = new DocCategoryLocalServiceClpInvoker();
}