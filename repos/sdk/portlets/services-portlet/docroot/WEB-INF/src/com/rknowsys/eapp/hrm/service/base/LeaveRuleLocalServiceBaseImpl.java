...
import com.rknowsys.eapp.hrm.service.LeaveRuleLocalService;
...
/**
 * Provides the base implementation for the leave rule local service.
 *
 * <p>
 ...
 * in {@link com.rknowsys.eapp.hrm.service.impl.LeaveRuleLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.LeaveRuleLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.LeaveRuleLocalServiceUtil
 * @generated
 */
public abstract class LeaveRuleLocalServiceBaseImpl extends
		BaseLocalServiceImpl implements LeaveRuleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 * 
	 * Never modify or reference this class directly. Always use {@link
	 * com.rknowsys.eapp.hrm.service.LeaveRuleLocalServiceUtil} to access the
	 * leave rule local service.
	 */

	/**
	 * Adds the leave rule to the database. Also notifies the appropriate model
	 * listeners.
	 *
	 * @param leaveRule
	 *            the leave rule
	...
	@Override
	public LeaveRule addLeaveRule(LeaveRule leaveRule) throws SystemException {
		leaveRule.setNew(true);

		return leaveRulePersistence.update(leaveRule);
	}

	/**
	 * Creates a new leave rule with the primary key. Does not add the leave
	 * rule to the database.
	 *
	 * @param leaveRuleId
	 *            the primary key for the new leave rule
	 * @return the new leave rule
	 */
	@Override
	public LeaveRule createLeaveRule(long leaveRuleId) {
		return leaveRulePersistence.create(leaveRuleId);
	}

	/**
	 * Deletes the leave rule with the primary key from the database. Also
	 * notifies the appropriate model listeners.
	 *
	 * @param leaveRuleId
	 *            the primary key of the leave rule
	 * @return the leave rule that was removed
	 * @throws PortalException
	 *             if a leave rule with the primary key could not be found
	 * @throws SystemException
	 *             if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveRule deleteLeaveRule(long leaveRuleId) throws PortalException,
			SystemException {
		return leaveRulePersistence.remove(leaveRuleId);
	}

	/**
	 * Deletes the leave rule from the database. Also notifies the appropriate
	 * model listeners.
	 *
	 * @param leaveRule
	 *            the leave rule
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveRule deleteLeaveRule(LeaveRule leaveRule)
			throws SystemException {
		return leaveRulePersistence.remove(leaveRule);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveRule.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery) throws SystemException {
		return leaveRulePersistence.findWithDynamicQuery(dynamicQuery);
	}
	 ...
	 * {@link com.rknowsys.eapp.hrm.model.impl.LeaveRuleModelImpl}. If both
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
			throws SystemException {
		return leaveRulePersistence.findWithDynamicQuery(dynamicQuery, start,
				end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
			throws SystemException {
		return leaveRulePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveRule fetchLeaveRule(long leaveRuleId) throws SystemException {
		return leaveRulePersistence.fetchByPrimaryKey(leaveRuleId);
	}
	 ...
	 */
	@Override
	public LeaveRule getLeaveRule(long leaveRuleId) throws PortalException,
			SystemException {
		return leaveRulePersistence.findByPrimaryKey(leaveRuleId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
			throws PortalException, SystemException {
		return leaveRulePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 *
	 * @param start
	 *            the lower bound of the range of leave rules
	 * @param end
	 *            the upper bound of the range of leave rules (not inclusive)
	 * @return the range of leave rules
	 * @throws SystemException
	 *             if a system exception occurred
	 */
	@Override
	public List<LeaveRule> getLeaveRules(int start, int end)
			throws SystemException {
		return leaveRulePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveRulesCount() throws SystemException {
		return leaveRulePersistence.countAll();
	}

	/**
	 * Updates the leave rule in the database or adds it if it does not yet
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveRule updateLeaveRule(LeaveRule leaveRule)
			throws SystemException {
		return leaveRulePersistence.update(leaveRule);
	}
	 ...
	 *
	 * @param docCategoryLocalService
	 *            the doc category local service
	 */
	 ...
	 *
	 * @param docCategoryPersistence
	 *            the doc category persistence
	 */
	 ...
	 *
	 * @param educationLocalService
	 *            the education local service
	 */
	 ...
	 *
	 * @param educationPersistence
	 *            the education persistence
	 */
	 ...
	 *
	 * @param empAttachmentLocalService
	 *            the EmpAttachment local service
	 */
	 ...
	 *
	 * @param empAttachmentPersistence
	 *            the EmpAttachment persistence
	 */
	 ...
	 *
	 * @param empContactDetailsLocalService
	 *            the EmpContactDetails local service
	 */
	 ...
	 *
	 * @param empContactDetailsPersistence
	 *            the EmpContactDetails persistence
	 */
	 ...
	 *
	 * @param empDependentLocalService
	 *            the emp dependent local service
	 */
	 ...
	 *
	 * @param empDependentPersistence
	 *            the emp dependent persistence
	 */
	 ...
	 *
	 * @param empDetailsLocalService
	 *            the emp details local service
	 */
	 ...
	 *
	 * @param empDetailsPersistence
	 *            the emp details persistence
	 */
	 ...
	 *
	 * @param empDetailsFinder
	 *            the emp details finder
	 */
	 ...
	 *
	 * @param empDirectDepositLocalService
	 *            the emp direct deposit local service
	 */
	 ...
	 *
	 * @param empDirectDepositPersistence
	 *            the emp direct deposit persistence
	 */
	 ...
	 *
	 * @param empEducationLocalService
	 *            the emp education local service
	 */
	 ...
	 *
	 * @param empEducationPersistence
	 *            the emp education persistence
	 */
	 ...
	 *
	 * @param empEmergencyContactLocalService
	 *            the EmpEmergencyContact local service
	 */
	 ...
	 *
	 * @param empEmergencyContactPersistence
	 *            the EmpEmergencyContact persistence
	 */
	 ...
	 *
	 * @param empImmigrationDocumentLocalService
	 *            the ImmigrationDocument local service
	 */
	 ...
	 *
	 * @param empImmigrationDocumentPersistence
	 *            the ImmigrationDocument persistence
	 */
	 ...
	 *
	 * @param empJobLocalService
	 *            the emp job local service
	 */
	 ...
	 *
	 * @param empJobPersistence
	 *            the emp job persistence
	 */
	 ...
	 *
	 * @param empLanguageLocalService
	 *            the emp language local service
	 */
	 ...
	 *
	 * @param empLanguagePersistence
	 *            the emp language persistence
	 */
	 ...
	 *
	 * @param empLicenseLocalService
	 *            the emp license local service
	 */
	 ...
	 *
	 * @param empLicensePersistence
	 *            the emp license persistence
	 */
	 ...
	 *
	 * @param employeePersistence
	 *            the Employee persistence
	 */
	 ...
	 *
	 * @param employmentStatusLocalService
	 ...
	 *
	 * @param employmentStatusPersistence
	 *            the employment status persistence
	 */
	 ...
	 *
	 * @param empMembershipLocalService
	 *            the emp membership local service
	 */
	 ...
	 *
	 * @param empMembershipPersistence
	 *            the emp membership persistence
	 */
	 ...
	 *
	 * @param empPersonalDetailsLocalService
	 *            the EmpPersonalDetails local service
	 */
	 ...
	 *
	 * @param empPersonalDetailsPersistence
	 *            the EmpPersonalDetails persistence
	 */
	 ...
	 *
	 * @param empPersonalDetailsFinder
	 *            the EmpPersonalDetails finder
	 */
	 ...
	 *
	 * @param empSalaryLocalService
	 *            the emp salary local service
	 */
	 ...
	 *
	 * @param empSalaryPersistence
	 *            the emp salary persistence
	 */
	 ...
	 *
	 * @param empSalaryComponentLocalService
	 *            the emp salary component local service
	 */
	 ...
	 *
	 * @param empSalaryComponentPersistence
	 *            the emp salary component persistence
	 */
	 ...
	 *
	 * @param empSkillLocalService
	 *            the emp skill local service
	 */
	 ...
	 *
	 * @param empSkillPersistence
	 *            the emp skill persistence
	 */
	 ...
	 *
	 * @param empSubordinateLocalService
	 *            the EmpSubordinate local service
	 */
	 ...
	 *
	 * @param empSubordinatePersistence
	 *            the EmpSubordinate persistence
	 */
	 ...
	 *
	 * @param empSupervisorLocalService
	 *            the EmpSupervisor local service
	 */
	 ...
	 *
	 * @param empSupervisorPersistence
	 *            the EmpSupervisor persistence
	 */
	 ...
	 *
	 * @param empWorkExpLocalService
	 *            the EmpWorkExp local service
	 */
	 ...
	 *
	 * @param empWorkExpPersistence
	 *            the EmpWorkExp persistence
	 */
	 ...
	 *
	 * @param holidayPersistence
	 *            the Holiday persistence
	 */
	 ...
	 *
	 * @param interviewLocalService
	 *            the interview local service
	 */
	 ...
	 *
	 * @param interviewPersistence
	 *            the interview persistence
	 */
	 ...
	 *
	 * @param jobCategoryLocalService
	 *            the job category local service
	 */
	 ...
	 *
	 * @param jobCategoryPersistence
	 *            the job category persistence
	 */
	 ...
	 *
	 * @param jobTitleLocalService
	 *            the job title local service
	 */
	 ...
	 *
	 * @param jobTitlePersistence
	 *            the job title persistence
	 */
	 ...
	 *
	 * @param languagePersistence
	 *            the language persistence
	 */
	 ...
	 *
	 * @param leaveCarryForwardPolicyLocalService
	 *            the leave carry forward policy local service
	 */
	 ...
	 *
	 * @param leaveCarryForwardPolicyPersistence
	 *            the leave carry forward policy persistence
	 */
	 ...
	 *
	 * @param leavePeriodLocalService
	 *            the leave period local service
	 */
	 ...
	 *
	 * @param leavePeriodPersistence
	 *            the leave period persistence
	 */
	 ...
	 *
	 * @param leaveRestrictionLocalService
	 ...
	 *
	 * @param leaveRestrictionPersistence
	 *            the leave restriction persistence
	 */
	 ...
	 *
	 * @param leaveRuleLocalService
	 *            the leave rule local service
	 */
	 ...
	 *
	 * @param leaveRulePersistence
	 *            the leave rule persistence
	 */
	 ...
	 *
	 * @param leaveTypeLocalService
	 *            the leave type local service
	 */
	 ...
	 *
	 * @param leaveTypePersistence
	 *            the leave type persistence
	 */
	 ...
	 *
	 * @param leaveTypeApplicabilityLocalService
	 *            the leave type applicability local service
	 */
	 ...
	 *
	 * @param leaveTypeApplicabilityPersistence
	 *            the leave type applicability persistence
	 */
	 ...
	 *
	 * @param licenseLocalService
	 *            the license local service
	 */
	 ...
	 *
	 * @param licensePersistence
	 *            the license persistence
	 */
	 ...
	 *
	 * @param locationLocalService
	 *            the location local service
	 */
	 ...
	 *
	 * @param membershipLocalService
	 *            the membership local service
	 */
	 ...
	 *
	 * @param membershipPersistence
	 *            the membership persistence
	 */
	 ...
	 *
	 * @param nationalityLocalService
	 *            the Nationality local service
	 */
	 ...
	 *
	 * @param nationalityPersistence
	 *            the Nationality persistence
	 */
	 ...
	 *
	 * @param newsLocalService
	 *            the news local service
	 */
	 ...
	 *
	 * @param newsPersistence
	 *            the news persistence
	 */
	 ...
	 *
	 * @param payGradeLocalService
	 *            the pay grade local service
	 */
	 ...
	 *
	 * @param payGradePersistence
	 *            the pay grade persistence
	 */
	 ...
	 *
	 * @param payGradeCurrencyLocalService
	 ...
	 *
	 * @param payGradeCurrencyPersistence
	 *            the pay grade currency persistence
	 */
	 ...
	 *
	 * @param reportingMethodsLocalService
	 ...
	 *
	 * @param reportingMethodsPersistence
	 *            the reporting methods persistence
	 */
	 ...
	 *
	 * @param salaryComponentLocalService
	 ...
	 *
	 * @param salaryComponentPersistence
	 *            the salary component persistence
	 */
	 ...
	 *
	 * @param skillLocalService
	 *            the skill local service
	 */
	 ...
	 *
	 * @param skillPersistence
	 *            the skill persistence
	 */
	 ...
	 *
	 * @param subUnitLocalService
	 *            the SubUnit local service
	 */
	 ...
	 *
	 * @param subUnitPersistence
	 *            the SubUnit persistence
	 */
	 ...
	 *
	 * @param terminationReasonsLocalService
	 *            the termination reasons local service
	 */
	 ...
	 *
	 * @param terminationReasonsPersistence
	 *            the termination reasons persistence
	 */
	 ...
	 *
	 * @param workshiftLocalService
	 *            the workshift local service
	 */
	 ...
	 *
	 * @param workshiftPersistence
	 *            the workshift persistence
	 */
	 ...
	 *
	 * @param workWeekLocalService
	 *            the WorkWeek local service
	 */
	 ...
	 *
	 * @param workWeekPersistence
	 *            the WorkWeek persistence
	 */
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register(
				"com.rknowsys.eapp.hrm.model.LeaveRule", leaveRuleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil
				.unregister("com.rknowsys.eapp.hrm.model.LeaveRule");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveRulePersistence.getDataSource();
	...
	private LeaveRuleLocalServiceClpInvoker _clpInvoker = new LeaveRuleLocalServiceClpInvoker();
}