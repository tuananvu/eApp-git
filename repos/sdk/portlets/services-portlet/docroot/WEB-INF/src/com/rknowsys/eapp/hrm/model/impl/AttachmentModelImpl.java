...
/**
 * The base model implementation for the Attachment service. Represents a row in the &quot;hrm_Attachment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AttachmentModelImpl extends BaseModelImpl<Attachment>
	 ...
	 */
	public static final String TABLE_NAME = "hrm_Attachment";
	...
	public static final String TABLE_SQL_CREATE = "create table hrm_Attachment (id_ LONG not null primary key,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table hrm_Attachment";
	public static final String ORDER_BY_JPQL = " ORDER BY attachment.id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY hrm_Attachment.id_ ASC";
