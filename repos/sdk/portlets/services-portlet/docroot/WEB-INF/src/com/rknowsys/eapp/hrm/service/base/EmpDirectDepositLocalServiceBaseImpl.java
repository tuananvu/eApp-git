...
import com.rknowsys.eapp.hrm.service.EmpDirectDepositLocalService;
...
/**
 * Provides the base implementation for the emp direct deposit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpDirectDepositLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpDirectDepositLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpDirectDepositLocalServiceUtil
 * @generated
 */
public abstract class EmpDirectDepositLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpDirectDepositLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpDirectDepositLocalServiceUtil} to access the emp direct deposit local service.
	 */
	...
	@Override
	public EmpDirectDeposit addEmpDirectDeposit(
		EmpDirectDeposit empDirectDeposit) throws SystemException {
		empDirectDeposit.setNew(true);

		return empDirectDepositPersistence.update(empDirectDeposit);
	}
	 ...
	 */
	@Override
	public EmpDirectDeposit createEmpDirectDeposit(long empDirectDepositId) {
		return empDirectDepositPersistence.create(empDirectDepositId);
	}
	...
	@Override
	public EmpDirectDeposit deleteEmpDirectDeposit(long empDirectDepositId)
		throws PortalException, SystemException {
		return empDirectDepositPersistence.remove(empDirectDepositId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpDirectDeposit deleteEmpDirectDeposit(
		EmpDirectDeposit empDirectDeposit) throws SystemException {
		return empDirectDepositPersistence.remove(empDirectDeposit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpDirectDeposit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return empDirectDepositPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empDirectDepositPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpDirectDeposit fetchEmpDirectDeposit(long empDirectDepositId)
		throws SystemException {
		return empDirectDepositPersistence.fetchByPrimaryKey(empDirectDepositId);
	}
	 ...
	 */
	@Override
	public EmpDirectDeposit getEmpDirectDeposit(long empDirectDepositId)
		throws PortalException, SystemException {
		return empDirectDepositPersistence.findByPrimaryKey(empDirectDepositId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empDirectDepositPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpDirectDeposit> getEmpDirectDeposits(int start, int end)
		throws SystemException {
		return empDirectDepositPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpDirectDepositsCount() throws SystemException {
		return empDirectDepositPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpDirectDeposit updateEmpDirectDeposit(
		EmpDirectDeposit empDirectDeposit) throws SystemException {
		return empDirectDepositPersistence.update(empDirectDeposit);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpDirectDeposit",
			empDirectDepositLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpDirectDeposit");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empDirectDepositPersistence.getDataSource();
	...
	private EmpDirectDepositLocalServiceClpInvoker _clpInvoker = new EmpDirectDepositLocalServiceClpInvoker();
}