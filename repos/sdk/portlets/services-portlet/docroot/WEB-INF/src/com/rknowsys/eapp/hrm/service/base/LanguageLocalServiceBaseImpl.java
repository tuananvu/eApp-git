...
public abstract class LanguageLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 */
	@Override
	public Language createLanguage(long id) {
		return languagePersistence.create(id);
	}
	...
	public Language deleteLanguage(long id)
		...
		return languagePersistence.remove(id);
	}
	...
	@Override
	public Language fetchLanguage(long id) throws SystemException {
		return languagePersistence.fetchByPrimaryKey(id);
	}
	...
	public Language getLanguage(long id)
		throws PortalException, SystemException {
		return languagePersistence.findByPrimaryKey(id);
	}
