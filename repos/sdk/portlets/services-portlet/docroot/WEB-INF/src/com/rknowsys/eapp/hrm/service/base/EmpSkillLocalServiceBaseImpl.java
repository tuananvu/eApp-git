...
import com.rknowsys.eapp.hrm.service.EmpSkillLocalService;
...
/**
 * Provides the base implementation for the emp skill local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpSkillLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpSkillLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpSkillLocalServiceUtil
 * @generated
 */
public abstract class EmpSkillLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EmpSkillLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpSkillLocalServiceUtil} to access the emp skill local service.
	 */
	...
	@Override
	public EmpSkill addEmpSkill(EmpSkill empSkill) throws SystemException {
		empSkill.setNew(true);

		return empSkillPersistence.update(empSkill);
	}
	 ...
	 */
	@Override
	public EmpSkill createEmpSkill(long empSkillId) {
		return empSkillPersistence.create(empSkillId);
	}
	...
	@Override
	public EmpSkill deleteEmpSkill(long empSkillId)
		throws PortalException, SystemException {
		return empSkillPersistence.remove(empSkillId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpSkill deleteEmpSkill(EmpSkill empSkill) throws SystemException {
		return empSkillPersistence.remove(empSkill);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpSkill.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return empSkillPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return empSkillPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return empSkillPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empSkillPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpSkill fetchEmpSkill(long empSkillId) throws SystemException {
		return empSkillPersistence.fetchByPrimaryKey(empSkillId);
	}
	 ...
	 */
	@Override
	public EmpSkill getEmpSkill(long empSkillId)
		throws PortalException, SystemException {
		return empSkillPersistence.findByPrimaryKey(empSkillId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empSkillPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpSkill> getEmpSkills(int start, int end)
		throws SystemException {
		return empSkillPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpSkillsCount() throws SystemException {
		return empSkillPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpSkill updateEmpSkill(EmpSkill empSkill) throws SystemException {
		return empSkillPersistence.update(empSkill);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpSkill",
			empSkillLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpSkill");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empSkillPersistence.getDataSource();
	...
	private EmpSkillLocalServiceClpInvoker _clpInvoker = new EmpSkillLocalServiceClpInvoker();
}