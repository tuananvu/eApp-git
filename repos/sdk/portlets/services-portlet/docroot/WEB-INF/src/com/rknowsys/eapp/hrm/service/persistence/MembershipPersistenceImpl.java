...
public class MembershipPersistenceImpl extends BasePersistenceImpl<Membership>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_EMPLOYEEID =
		new FinderPath(MembershipModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			MembershipModelImpl.EMPLOYEEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_EMPLOYEEID = new FinderPath(MembershipModelImpl.ENTITY_CACHE_ENABLED,
			MembershipModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Membership> findByemployeeId(long employeeId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Membership> findByemployeeId(long employeeId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Membership> findByemployeeId(long employeeId, int start,
		int end, OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((list != null) && !list.isEmpty()) {
			for (Membership membership : list) {
				if ((employeeId != membership.getEmployeeId())) {
					list = null;
	 ...
	 */
	@Override
	public Membership findByemployeeId_First(long employeeId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipException, SystemException {
		Membership membership = fetchByemployeeId_First(employeeId,
				orderByComparator);
	 ...
	 */
	@Override
	public Membership fetchByemployeeId_First(long employeeId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Membership> list = findByemployeeId(employeeId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Membership findByemployeeId_Last(long employeeId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipException, SystemException {
		Membership membership = fetchByemployeeId_Last(employeeId,
				orderByComparator);
	 ...
	 */
	@Override
	public Membership fetchByemployeeId_Last(long employeeId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Membership> list = findByemployeeId(employeeId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Membership[] findByemployeeId_PrevAndNext(long membershipId,
		...
		try {
			...
			array[0] = getByemployeeId_PrevAndNext(session, membership,
					employeeId, orderByComparator, true);

			array[1] = membership;

			array[2] = getByemployeeId_PrevAndNext(session, membership,
	...
	protected Membership getByemployeeId_PrevAndNext(Session session,
		Membership membership, long employeeId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByemployeeId(long employeeId) throws SystemException {
		for (Membership membership : findByemployeeId(employeeId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(membership);
		}
	}
	...
	private static final String _FINDER_COLUMN_EMPLOYEEID_EMPLOYEEID_2 = "membership.employeeId = ?";
	...
	public Membership updateImpl(
		...
		if (isNew || !MembershipModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((membershipModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						membershipModelImpl.getOriginalEmployeeId()
					};
				...
				args = new Object[] { membershipModelImpl.getEmployeeId() };
	...
	protected Membership toUnwrappedModel(Membership membership) {
		...
		membershipImpl.setEmployeeId(membership.getEmployeeId());
