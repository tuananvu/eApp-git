...
import com.rknowsys.eapp.hrm.service.TerminationReasonsLocalService;
...
/**
 * Provides the base implementation for the termination reasons local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.TerminationReasonsLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.TerminationReasonsLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.TerminationReasonsLocalServiceUtil
 * @generated
 */
public abstract class TerminationReasonsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TerminationReasonsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.TerminationReasonsLocalServiceUtil} to access the termination reasons local service.
	 */
	...
	@Override
	public TerminationReasons addTerminationReasons(
		TerminationReasons terminationReasons) throws SystemException {
		terminationReasons.setNew(true);

		return terminationReasonsPersistence.update(terminationReasons);
	}
	 ...
	 */
	@Override
	public TerminationReasons createTerminationReasons(
		long terminationreasonsId) {
		return terminationReasonsPersistence.create(terminationreasonsId);
	}
	...
	@Override
	public TerminationReasons deleteTerminationReasons(
		long terminationreasonsId) throws PortalException, SystemException {
		return terminationReasonsPersistence.remove(terminationreasonsId);
	}
	...
	public TerminationReasons deleteTerminationReasons(
		TerminationReasons terminationReasons) throws SystemException {
		return terminationReasonsPersistence.remove(terminationReasons);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TerminationReasons.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return terminationReasonsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return terminationReasonsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TerminationReasons fetchTerminationReasons(long terminationreasonsId)
		throws SystemException {
		return terminationReasonsPersistence.fetchByPrimaryKey(terminationreasonsId);
	}
	 ...
	 */
	@Override
	public TerminationReasons getTerminationReasons(long terminationreasonsId)
		throws PortalException, SystemException {
		return terminationReasonsPersistence.findByPrimaryKey(terminationreasonsId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return terminationReasonsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TerminationReasons> getTerminationReasonses(int start, int end)
		throws SystemException {
		return terminationReasonsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTerminationReasonsesCount() throws SystemException {
		return terminationReasonsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TerminationReasons updateTerminationReasons(
		TerminationReasons terminationReasons) throws SystemException {
		return terminationReasonsPersistence.update(terminationReasons);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.TerminationReasons",
			terminationReasonsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.TerminationReasons");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = terminationReasonsPersistence.getDataSource();
	...
	private TerminationReasonsLocalServiceClpInvoker _clpInvoker = new TerminationReasonsLocalServiceClpInvoker();
}