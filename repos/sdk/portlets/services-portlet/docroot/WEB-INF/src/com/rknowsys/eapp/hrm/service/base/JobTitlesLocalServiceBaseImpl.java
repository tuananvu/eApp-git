...
import com.rknowsys.eapp.hrm.service.JobTitlesLocalService;
...
/**
 * Provides the base implementation for the job titles local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.JobTitlesLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class JobTitlesLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements JobTitlesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.JobTitlesLocalServiceUtil} to access the job titles local service.
	 */
	...
	@Override
	public JobTitles addJobTitles(JobTitles jobTitles)
		throws SystemException {
		jobTitles.setNew(true);

		return jobTitlesPersistence.update(jobTitles);
	}
	 ...
	 */
	@Override
	public JobTitles createJobTitles(long id) {
		return jobTitlesPersistence.create(id);
	}
	...
	@Override
	public JobTitles deleteJobTitles(long id)
		throws PortalException, SystemException {
		return jobTitlesPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobTitles deleteJobTitles(JobTitles jobTitles)
		throws SystemException {
		return jobTitlesPersistence.remove(jobTitles);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(JobTitles.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return jobTitlesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return jobTitlesPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return jobTitlesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public JobTitles fetchJobTitles(long id) throws SystemException {
		return jobTitlesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public JobTitles getJobTitles(long id)
		throws PortalException, SystemException {
		return jobTitlesPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return jobTitlesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JobTitles> getJobTitleses(int start, int end)
		throws SystemException {
		return jobTitlesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getJobTitlesesCount() throws SystemException {
		return jobTitlesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JobTitles updateJobTitles(JobTitles jobTitles)
		throws SystemException {
		return jobTitlesPersistence.update(jobTitles);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.JobTitles",
			jobTitlesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = jobTitlesPersistence.getDataSource();
	...
	private JobTitlesLocalServiceClpInvoker _clpInvoker = new JobTitlesLocalServiceClpInvoker();
}