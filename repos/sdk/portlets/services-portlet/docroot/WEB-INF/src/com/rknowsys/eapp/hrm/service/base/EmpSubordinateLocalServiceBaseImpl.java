...
import com.rknowsys.eapp.hrm.service.EmpSubordinateLocalService;
...
/**
 * Provides the base implementation for the EmpSubordinate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpSubordinateLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpSubordinateLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpSubordinateLocalServiceUtil
 * @generated
 */
public abstract class EmpSubordinateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpSubordinateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpSubordinateLocalServiceUtil} to access the EmpSubordinate local service.
	 */
	...
	@Override
	public EmpSubordinate addEmpSubordinate(EmpSubordinate empSubordinate)
		throws SystemException {
		empSubordinate.setNew(true);

		return empSubordinatePersistence.update(empSubordinate);
	}
	 ...
	 */
	@Override
	public EmpSubordinate createEmpSubordinate(long empSubordinateId) {
		return empSubordinatePersistence.create(empSubordinateId);
	}
	...
	@Override
	public EmpSubordinate deleteEmpSubordinate(long empSubordinateId)
		throws PortalException, SystemException {
		return empSubordinatePersistence.remove(empSubordinateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpSubordinate deleteEmpSubordinate(EmpSubordinate empSubordinate)
		throws SystemException {
		return empSubordinatePersistence.remove(empSubordinate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpSubordinate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empSubordinatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empSubordinatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpSubordinate fetchEmpSubordinate(long empSubordinateId)
		throws SystemException {
		return empSubordinatePersistence.fetchByPrimaryKey(empSubordinateId);
	}
	 ...
	 */
	@Override
	public EmpSubordinate getEmpSubordinate(long empSubordinateId)
		throws PortalException, SystemException {
		return empSubordinatePersistence.findByPrimaryKey(empSubordinateId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empSubordinatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpSubordinate> getEmpSubordinates(int start, int end)
		throws SystemException {
		return empSubordinatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpSubordinatesCount() throws SystemException {
		return empSubordinatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpSubordinate updateEmpSubordinate(EmpSubordinate empSubordinate)
		throws SystemException {
		return empSubordinatePersistence.update(empSubordinate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpSubordinate",
			empSubordinateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empSubordinatePersistence.getDataSource();
	...
	private EmpSubordinateLocalServiceClpInvoker _clpInvoker = new EmpSubordinateLocalServiceClpInvoker();
}