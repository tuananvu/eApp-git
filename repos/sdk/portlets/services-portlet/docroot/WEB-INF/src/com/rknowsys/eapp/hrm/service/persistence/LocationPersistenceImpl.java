...
import com.rknowsys.eapp.hrm.model.impl.LocationImpl;
import com.rknowsys.eapp.hrm.model.impl.LocationModelImpl;
...
public class LocationPersistenceImpl extends BasePersistenceImpl<Location>
	...
	@Override
	public Location updateImpl(com.rknowsys.eapp.hrm.model.Location location)
		throws SystemException {
		location = toUnwrappedModel(location);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.rknowsys.eapp.hrm.model.Location")));
