...
import com.rknowsys.eapp.hrm.service.EmpMembershipLocalService;
...
/**
 * Provides the base implementation for the emp membership local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpMembershipLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpMembershipLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpMembershipLocalServiceUtil
 * @generated
 */
public abstract class EmpMembershipLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpMembershipLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpMembershipLocalServiceUtil} to access the emp membership local service.
	 */
	...
	@Override
	public EmpMembership addEmpMembership(EmpMembership empMembership)
		throws SystemException {
		empMembership.setNew(true);

		return empMembershipPersistence.update(empMembership);
	}
	 ...
	 */
	@Override
	public EmpMembership createEmpMembership(long empMembershipId) {
		return empMembershipPersistence.create(empMembershipId);
	}
	...
	@Override
	public EmpMembership deleteEmpMembership(long empMembershipId)
		throws PortalException, SystemException {
		return empMembershipPersistence.remove(empMembershipId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpMembership deleteEmpMembership(EmpMembership empMembership)
		throws SystemException {
		return empMembershipPersistence.remove(empMembership);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpMembership.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empMembershipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empMembershipPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpMembership fetchEmpMembership(long empMembershipId)
		throws SystemException {
		return empMembershipPersistence.fetchByPrimaryKey(empMembershipId);
	}
	 ...
	 */
	@Override
	public EmpMembership getEmpMembership(long empMembershipId)
		throws PortalException, SystemException {
		return empMembershipPersistence.findByPrimaryKey(empMembershipId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empMembershipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpMembership> getEmpMemberships(int start, int end)
		throws SystemException {
		return empMembershipPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpMembershipsCount() throws SystemException {
		return empMembershipPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpMembership updateEmpMembership(EmpMembership empMembership)
		throws SystemException {
		return empMembershipPersistence.update(empMembership);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpMembership",
			empMembershipLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpMembership");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empMembershipPersistence.getDataSource();
	...
	private EmpMembershipLocalServiceClpInvoker _clpInvoker = new EmpMembershipLocalServiceClpInvoker();
}