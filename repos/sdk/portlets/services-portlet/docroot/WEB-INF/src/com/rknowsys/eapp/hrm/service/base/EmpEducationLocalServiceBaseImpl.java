...
import com.rknowsys.eapp.hrm.service.EmpEducationLocalService;
...
/**
 * Provides the base implementation for the emp education local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpEducationLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class EmpEducationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpEducationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpEducationLocalServiceUtil} to access the emp education local service.
	 */
	...
	@Override
	public EmpEducation addEmpEducation(EmpEducation empEducation)
		throws SystemException {
		empEducation.setNew(true);

		return empEducationPersistence.update(empEducation);
	}
	 ...
	 */
	@Override
	public EmpEducation createEmpEducation(long empEducationId) {
		return empEducationPersistence.create(empEducationId);
	}
	...
	@Override
	public EmpEducation deleteEmpEducation(long empEducationId)
		throws PortalException, SystemException {
		return empEducationPersistence.remove(empEducationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpEducation deleteEmpEducation(EmpEducation empEducation)
		throws SystemException {
		return empEducationPersistence.remove(empEducation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpEducation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empEducationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empEducationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpEducation fetchEmpEducation(long empEducationId)
		throws SystemException {
		return empEducationPersistence.fetchByPrimaryKey(empEducationId);
	}
	 ...
	 */
	@Override
	public EmpEducation getEmpEducation(long empEducationId)
		throws PortalException, SystemException {
		return empEducationPersistence.findByPrimaryKey(empEducationId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empEducationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpEducation> getEmpEducations(int start, int end)
		throws SystemException {
		return empEducationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpEducationsCount() throws SystemException {
		return empEducationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpEducation updateEmpEducation(EmpEducation empEducation)
		throws SystemException {
		return empEducationPersistence.update(empEducation);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpEducation",
			empEducationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpEducation");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empEducationPersistence.getDataSource();
	...
	private EmpEducationLocalServiceClpInvoker _clpInvoker = new EmpEducationLocalServiceClpInvoker();
}