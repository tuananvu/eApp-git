...
public class InterviewLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return InterviewLocalServiceUtil.addInterview((com.rknowsys.eapp.hrm.model.Interview)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return InterviewLocalServiceUtil.deleteInterview((com.rknowsys.eapp.hrm.model.Interview)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return InterviewLocalServiceUtil.updateInterview((com.rknowsys.eapp.hrm.model.Interview)arguments[0]);
		}
