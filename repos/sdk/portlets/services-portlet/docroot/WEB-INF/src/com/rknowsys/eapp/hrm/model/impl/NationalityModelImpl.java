...
public class NationalityModelImpl extends BaseModelImpl<Nationality>
	...
	public static final String TABLE_SQL_CREATE = "create table nationality (nationalityId LONG not null primary key,employeeId LONG,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";
	...
	public Object clone() {
		...
		nationalityImpl.setEmployeeId(getEmployeeId());
	...
	public CacheModel<Nationality> toCacheModel() {
		...
		nationalityCacheModel.employeeId = getEmployeeId();
