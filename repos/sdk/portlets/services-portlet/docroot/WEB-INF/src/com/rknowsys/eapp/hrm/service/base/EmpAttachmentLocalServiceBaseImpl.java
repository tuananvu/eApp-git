...
import com.rknowsys.eapp.hrm.service.EmpAttachmentLocalService;
...
/**
 * Provides the base implementation for the EmpAttachment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpAttachmentLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpAttachmentLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpAttachmentLocalServiceUtil
 * @generated
 */
public abstract class EmpAttachmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpAttachmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpAttachmentLocalServiceUtil} to access the EmpAttachment local service.
	 */
	...
	@Override
	public EmpAttachment addEmpAttachment(EmpAttachment empAttachment)
		throws SystemException {
		empAttachment.setNew(true);

		return empAttachmentPersistence.update(empAttachment);
	}
	 ...
	 */
	@Override
	public EmpAttachment createEmpAttachment(long empAttachmentId) {
		return empAttachmentPersistence.create(empAttachmentId);
	}
	...
	@Override
	public EmpAttachment deleteEmpAttachment(long empAttachmentId)
		throws PortalException, SystemException {
		return empAttachmentPersistence.remove(empAttachmentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpAttachment deleteEmpAttachment(EmpAttachment empAttachment)
		throws SystemException {
		return empAttachmentPersistence.remove(empAttachment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpAttachment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empAttachmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empAttachmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpAttachment fetchEmpAttachment(long empAttachmentId)
		throws SystemException {
		return empAttachmentPersistence.fetchByPrimaryKey(empAttachmentId);
	}
	 ...
	 */
	@Override
	public EmpAttachment getEmpAttachment(long empAttachmentId)
		throws PortalException, SystemException {
		return empAttachmentPersistence.findByPrimaryKey(empAttachmentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empAttachmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpAttachment> getEmpAttachments(int start, int end)
		throws SystemException {
		return empAttachmentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpAttachmentsCount() throws SystemException {
		return empAttachmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpAttachment updateEmpAttachment(EmpAttachment empAttachment)
		throws SystemException {
		return empAttachmentPersistence.update(empAttachment);
	}

	@Override
	public EmpAttachmentFileBlobModel getFileBlobModel(Serializable primaryKey)
		throws SystemException {
		Session session = null;

		try {
			session = empAttachmentPersistence.openSession();

			return (com.rknowsys.eapp.hrm.model.EmpAttachmentFileBlobModel)session.get(EmpAttachmentFileBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw empAttachmentPersistence.processException(e);
		}
		finally {
			empAttachmentPersistence.closeSession(session);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpAttachment",
			empAttachmentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empAttachmentPersistence.getDataSource();
	...
	private EmpAttachmentLocalServiceClpInvoker _clpInvoker = new EmpAttachmentLocalServiceClpInvoker();
}