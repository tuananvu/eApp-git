...
import com.rknowsys.eapp.hrm.service.JobLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.JobLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
...
public abstract class JobLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.JobLocalServiceUtil} to access the job local service.
	 */
	...
	@Override
	public JobContractDetailsBlobModel getContractDetailsBlobModel(
		Serializable primaryKey) throws SystemException {
		Session session = null;

		try {
			session = jobPersistence.openSession();

			return (com.rknowsys.eapp.hrm.model.JobContractDetailsBlobModel)session.get(JobContractDetailsBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw jobPersistence.processException(e);
		}
		finally {
			jobPersistence.closeSession(session);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Job",
			jobLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.Job");
	}
