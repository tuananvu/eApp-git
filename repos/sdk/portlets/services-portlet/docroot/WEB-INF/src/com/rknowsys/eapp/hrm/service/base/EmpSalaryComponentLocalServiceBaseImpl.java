...
import com.rknowsys.eapp.hrm.service.EmpSalaryComponentLocalService;
...
/**
 * Provides the base implementation for the emp salary component local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpSalaryComponentLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class EmpSalaryComponentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpSalaryComponentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpSalaryComponentLocalServiceUtil} to access the emp salary component local service.
	 */
	...
	@Override
	public EmpSalaryComponent addEmpSalaryComponent(
		EmpSalaryComponent empSalaryComponent) throws SystemException {
		empSalaryComponent.setNew(true);

		return empSalaryComponentPersistence.update(empSalaryComponent);
	}
	 ...
	 */
	@Override
	public EmpSalaryComponent createEmpSalaryComponent(long empSalaryEarningId) {
		return empSalaryComponentPersistence.create(empSalaryEarningId);
	}
	...
	@Override
	public EmpSalaryComponent deleteEmpSalaryComponent(long empSalaryEarningId)
		throws PortalException, SystemException {
		return empSalaryComponentPersistence.remove(empSalaryEarningId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpSalaryComponent deleteEmpSalaryComponent(
		EmpSalaryComponent empSalaryComponent) throws SystemException {
		return empSalaryComponentPersistence.remove(empSalaryComponent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpSalaryComponent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return empSalaryComponentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empSalaryComponentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpSalaryComponent fetchEmpSalaryComponent(long empSalaryEarningId)
		throws SystemException {
		return empSalaryComponentPersistence.fetchByPrimaryKey(empSalaryEarningId);
	}
	 ...
	 */
	@Override
	public EmpSalaryComponent getEmpSalaryComponent(long empSalaryEarningId)
		throws PortalException, SystemException {
		return empSalaryComponentPersistence.findByPrimaryKey(empSalaryEarningId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empSalaryComponentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpSalaryComponent> getEmpSalaryComponents(int start, int end)
		throws SystemException {
		return empSalaryComponentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpSalaryComponentsCount() throws SystemException {
		return empSalaryComponentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpSalaryComponent updateEmpSalaryComponent(
		EmpSalaryComponent empSalaryComponent) throws SystemException {
		return empSalaryComponentPersistence.update(empSalaryComponent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpSalaryComponent",
			empSalaryComponentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpSalaryComponent");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empSalaryComponentPersistence.getDataSource();
	...
	private EmpSalaryComponentLocalServiceClpInvoker _clpInvoker = new EmpSalaryComponentLocalServiceClpInvoker();
}