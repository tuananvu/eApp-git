...
import com.rknowsys.eapp.hrm.service.JobTitleLocalService;
...
/**
 * Provides the base implementation for the job title local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.JobTitleLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.JobTitleLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.JobTitleLocalServiceUtil
 * @generated
 */
public abstract class JobTitleLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements JobTitleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.JobTitleLocalServiceUtil} to access the job title local service.
	 */
	...
	@Override
	public JobTitle addJobTitle(JobTitle jobTitle) throws SystemException {
		jobTitle.setNew(true);

		return jobTitlePersistence.update(jobTitle);
	}
	 ...
	 */
	@Override
	public JobTitle createJobTitle(long jobTitleId) {
		return jobTitlePersistence.create(jobTitleId);
	}
	...
	@Override
	public JobTitle deleteJobTitle(long jobTitleId)
		throws PortalException, SystemException {
		return jobTitlePersistence.remove(jobTitleId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobTitle deleteJobTitle(JobTitle jobTitle) throws SystemException {
		return jobTitlePersistence.remove(jobTitle);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(JobTitle.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return jobTitlePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return jobTitlePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return jobTitlePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return jobTitlePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public JobTitle fetchJobTitle(long jobTitleId) throws SystemException {
		return jobTitlePersistence.fetchByPrimaryKey(jobTitleId);
	}
	 ...
	 */
	@Override
	public JobTitle getJobTitle(long jobTitleId)
		throws PortalException, SystemException {
		return jobTitlePersistence.findByPrimaryKey(jobTitleId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return jobTitlePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JobTitle> getJobTitles(int start, int end)
		throws SystemException {
		return jobTitlePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getJobTitlesCount() throws SystemException {
		return jobTitlePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JobTitle updateJobTitle(JobTitle jobTitle) throws SystemException {
		return jobTitlePersistence.update(jobTitle);
	}
	...
	public void addLeaveTypeApplicabilityJobTitle(
		...
		throws SystemException {
		leaveTypeApplicabilityPersistence.addJobTitle(leaveTypeApplicabilityId,
			jobTitleId);
	}
	...
	@Override
	public void addLeaveTypeApplicabilityJobTitle(
		long leaveTypeApplicabilityId, JobTitle jobTitle)
		throws SystemException {
		leaveTypeApplicabilityPersistence.addJobTitle(leaveTypeApplicabilityId,
			jobTitle);
	}
	...
	public void addLeaveTypeApplicabilityJobTitles(
		...
		throws SystemException {
		leaveTypeApplicabilityPersistence.addJobTitles(leaveTypeApplicabilityId,
			jobTitleIds);
	}
	...
	@Override
	public void addLeaveTypeApplicabilityJobTitles(
		long leaveTypeApplicabilityId, List<JobTitle> JobTitles)
		throws SystemException {
		leaveTypeApplicabilityPersistence.addJobTitles(leaveTypeApplicabilityId,
			JobTitles);
	}
	...
	public void clearLeaveTypeApplicabilityJobTitles(
		...
		leaveTypeApplicabilityPersistence.clearJobTitles(leaveTypeApplicabilityId);
	}
	...
	public void deleteLeaveTypeApplicabilityJobTitle(
		long leaveTypeApplicabilityId, long jobTitleId)
		throws SystemException {
		leaveTypeApplicabilityPersistence.removeJobTitle(leaveTypeApplicabilityId,
			jobTitleId);
	}
	...
	public void deleteLeaveTypeApplicabilityJobTitles(
		long leaveTypeApplicabilityId, long[] jobTitleIds)
		throws SystemException {
		leaveTypeApplicabilityPersistence.removeJobTitles(leaveTypeApplicabilityId,
			jobTitleIds);
	}
	 ...
	 */
	@Override
	public List<JobTitle> getLeaveTypeApplicabilityJobTitles(
		long leaveTypeApplicabilityId) throws SystemException {
		return leaveTypeApplicabilityPersistence.getJobTitles(leaveTypeApplicabilityId);
	}
	...
	public int getLeaveTypeApplicabilityJobTitlesCount(
		long leaveTypeApplicabilityId) throws SystemException {
		return leaveTypeApplicabilityPersistence.getJobTitlesSize(leaveTypeApplicabilityId);
	}
	...
	public boolean hasLeaveTypeApplicabilityJobTitle(
		long leaveTypeApplicabilityId, long jobTitleId)
		throws SystemException {
		return leaveTypeApplicabilityPersistence.containsJobTitle(leaveTypeApplicabilityId,
			jobTitleId);
	}
	...
	public boolean hasLeaveTypeApplicabilityJobTitles(
		long leaveTypeApplicabilityId) throws SystemException {
		return leaveTypeApplicabilityPersistence.containsJobTitles(leaveTypeApplicabilityId);
	}
	...
	public void setLeaveTypeApplicabilityJobTitles(
		long leaveTypeApplicabilityId, long[] jobTitleIds)
		throws SystemException {
		leaveTypeApplicabilityPersistence.setJobTitles(leaveTypeApplicabilityId,
			jobTitleIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.JobTitle",
			jobTitleLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = jobTitlePersistence.getDataSource();
	...
	private JobTitleLocalServiceClpInvoker _clpInvoker = new JobTitleLocalServiceClpInvoker();
}