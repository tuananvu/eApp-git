...
import com.rknowsys.eapp.hrm.service.LeaveCarryForwardPolicyLocalService;
...
/**
 * Provides the base implementation for the leave carry forward policy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LeaveCarryForwardPolicyLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.LeaveCarryForwardPolicyLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.LeaveCarryForwardPolicyLocalServiceUtil
 * @generated
 */
public abstract class LeaveCarryForwardPolicyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveCarryForwardPolicyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LeaveCarryForwardPolicyLocalServiceUtil} to access the leave carry forward policy local service.
	 */
	...
	@Override
	public LeaveCarryForwardPolicy addLeaveCarryForwardPolicy(
		LeaveCarryForwardPolicy leaveCarryForwardPolicy)
		throws SystemException {
		leaveCarryForwardPolicy.setNew(true);

		return leaveCarryForwardPolicyPersistence.update(leaveCarryForwardPolicy);
	}
	 ...
	 */
	@Override
	public LeaveCarryForwardPolicy createLeaveCarryForwardPolicy(
		long leaveCarryForwardPolicyId) {
		return leaveCarryForwardPolicyPersistence.create(leaveCarryForwardPolicyId);
	}
	...
	@Override
	public LeaveCarryForwardPolicy deleteLeaveCarryForwardPolicy(
		long leaveCarryForwardPolicyId) throws PortalException, SystemException {
		return leaveCarryForwardPolicyPersistence.remove(leaveCarryForwardPolicyId);
	}
	...
	public LeaveCarryForwardPolicy deleteLeaveCarryForwardPolicy(
		LeaveCarryForwardPolicy leaveCarryForwardPolicy)
		throws SystemException {
		return leaveCarryForwardPolicyPersistence.remove(leaveCarryForwardPolicy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveCarryForwardPolicy.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveCarryForwardPolicyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveCarryForwardPolicyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveCarryForwardPolicy fetchLeaveCarryForwardPolicy(
		long leaveCarryForwardPolicyId) throws SystemException {
		return leaveCarryForwardPolicyPersistence.fetchByPrimaryKey(leaveCarryForwardPolicyId);
	}
	...
	public LeaveCarryForwardPolicy getLeaveCarryForwardPolicy(
		long leaveCarryForwardPolicyId) throws PortalException, SystemException {
		return leaveCarryForwardPolicyPersistence.findByPrimaryKey(leaveCarryForwardPolicyId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return leaveCarryForwardPolicyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveCarryForwardPolicy> getLeaveCarryForwardPolicies(
		int start, int end) throws SystemException {
		return leaveCarryForwardPolicyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveCarryForwardPoliciesCount() throws SystemException {
		return leaveCarryForwardPolicyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveCarryForwardPolicy updateLeaveCarryForwardPolicy(
		LeaveCarryForwardPolicy leaveCarryForwardPolicy)
		throws SystemException {
		return leaveCarryForwardPolicyPersistence.update(leaveCarryForwardPolicy);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.LeaveCarryForwardPolicy",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveCarryForwardPolicyPersistence.getDataSource();
	...
	private LeaveCarryForwardPolicyLocalServiceClpInvoker _clpInvoker = new LeaveCarryForwardPolicyLocalServiceClpInvoker();
}