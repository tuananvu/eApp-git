...
import com.rknowsys.eapp.hrm.service.EmpContactDetailsLocalService;
...
/**
 * Provides the base implementation for the EmpContactDetails local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpContactDetailsLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpContactDetailsLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpContactDetailsLocalServiceUtil
 * @generated
 */
public abstract class EmpContactDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpContactDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpContactDetailsLocalServiceUtil} to access the EmpContactDetails local service.
	 */
	...
	@Override
	public EmpContactDetails addEmpContactDetails(
		EmpContactDetails empContactDetails) throws SystemException {
		empContactDetails.setNew(true);

		return empContactDetailsPersistence.update(empContactDetails);
	}
	 ...
	 */
	@Override
	public EmpContactDetails createEmpContactDetails(long empContactDetailsId) {
		return empContactDetailsPersistence.create(empContactDetailsId);
	}
	...
	@Override
	public EmpContactDetails deleteEmpContactDetails(long empContactDetailsId)
		throws PortalException, SystemException {
		return empContactDetailsPersistence.remove(empContactDetailsId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpContactDetails deleteEmpContactDetails(
		EmpContactDetails empContactDetails) throws SystemException {
		return empContactDetailsPersistence.remove(empContactDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpContactDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return empContactDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empContactDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpContactDetails fetchEmpContactDetails(long empContactDetailsId)
		throws SystemException {
		return empContactDetailsPersistence.fetchByPrimaryKey(empContactDetailsId);
	}
	 ...
	 */
	@Override
	public EmpContactDetails getEmpContactDetails(long empContactDetailsId)
		throws PortalException, SystemException {
		return empContactDetailsPersistence.findByPrimaryKey(empContactDetailsId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empContactDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpContactDetails> getEmpContactDetailses(int start, int end)
		throws SystemException {
		return empContactDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpContactDetailsesCount() throws SystemException {
		return empContactDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpContactDetails updateEmpContactDetails(
		EmpContactDetails empContactDetails) throws SystemException {
		return empContactDetailsPersistence.update(empContactDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpContactDetails",
			empContactDetailsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empContactDetailsPersistence.getDataSource();
	...
	private EmpContactDetailsLocalServiceClpInvoker _clpInvoker = new EmpContactDetailsLocalServiceClpInvoker();
}