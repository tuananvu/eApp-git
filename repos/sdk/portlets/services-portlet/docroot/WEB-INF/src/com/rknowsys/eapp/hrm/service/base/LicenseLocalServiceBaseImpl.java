...
public abstract class LicenseLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 */
	@Override
	public License createLicense(long id) {
		return licensePersistence.create(id);
	}
	...
	public License deleteLicense(long id)
		...
		return licensePersistence.remove(id);
	}
	...
	@Override
	public License fetchLicense(long id) throws SystemException {
		return licensePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public License getLicense(long id) throws PortalException, SystemException {
		return licensePersistence.findByPrimaryKey(id);
	}
