...
import com.rknowsys.eapp.hrm.service.EmpLanguageLocalService;
...
/**
 * Provides the base implementation for the emp language local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpLanguageLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpLanguageLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpLanguageLocalServiceUtil
 * @generated
 */
public abstract class EmpLanguageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpLanguageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpLanguageLocalServiceUtil} to access the emp language local service.
	 */
	...
	@Override
	public EmpLanguage addEmpLanguage(EmpLanguage empLanguage)
		throws SystemException {
		empLanguage.setNew(true);

		return empLanguagePersistence.update(empLanguage);
	}
	 ...
	 */
	@Override
	public EmpLanguage createEmpLanguage(long empLanguageId) {
		return empLanguagePersistence.create(empLanguageId);
	}
	...
	@Override
	public EmpLanguage deleteEmpLanguage(long empLanguageId)
		throws PortalException, SystemException {
		return empLanguagePersistence.remove(empLanguageId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpLanguage deleteEmpLanguage(EmpLanguage empLanguage)
		throws SystemException {
		return empLanguagePersistence.remove(empLanguage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpLanguage.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empLanguagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return empLanguagePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empLanguagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpLanguage fetchEmpLanguage(long empLanguageId)
		throws SystemException {
		return empLanguagePersistence.fetchByPrimaryKey(empLanguageId);
	}
	 ...
	 */
	@Override
	public EmpLanguage getEmpLanguage(long empLanguageId)
		throws PortalException, SystemException {
		return empLanguagePersistence.findByPrimaryKey(empLanguageId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empLanguagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpLanguage> getEmpLanguages(int start, int end)
		throws SystemException {
		return empLanguagePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpLanguagesCount() throws SystemException {
		return empLanguagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpLanguage updateEmpLanguage(EmpLanguage empLanguage)
		throws SystemException {
		return empLanguagePersistence.update(empLanguage);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpLanguage",
			empLanguageLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empLanguagePersistence.getDataSource();
	...
	private EmpLanguageLocalServiceClpInvoker _clpInvoker = new EmpLanguageLocalServiceClpInvoker();
}