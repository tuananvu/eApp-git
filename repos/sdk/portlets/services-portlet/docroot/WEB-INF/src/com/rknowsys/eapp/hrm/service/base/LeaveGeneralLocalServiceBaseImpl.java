...
import com.rknowsys.eapp.hrm.service.LeaveGeneralLocalService;
...
/**
 * Provides the base implementation for the leave general local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LeaveGeneralLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class LeaveGeneralLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveGeneralLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LeaveGeneralLocalServiceUtil} to access the leave general local service.
	 */
	...
	@Override
	public LeaveGeneral addLeaveGeneral(LeaveGeneral leaveGeneral)
		throws SystemException {
		leaveGeneral.setNew(true);

		return leaveGeneralPersistence.update(leaveGeneral);
	}
	 ...
	 */
	@Override
	public LeaveGeneral createLeaveGeneral(long leaveGeneralId) {
		return leaveGeneralPersistence.create(leaveGeneralId);
	}
	...
	@Override
	public LeaveGeneral deleteLeaveGeneral(long leaveGeneralId)
		throws PortalException, SystemException {
		return leaveGeneralPersistence.remove(leaveGeneralId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveGeneral deleteLeaveGeneral(LeaveGeneral leaveGeneral)
		throws SystemException {
		return leaveGeneralPersistence.remove(leaveGeneral);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveGeneral.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveGeneralPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveGeneralPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveGeneral fetchLeaveGeneral(long leaveGeneralId)
		throws SystemException {
		return leaveGeneralPersistence.fetchByPrimaryKey(leaveGeneralId);
	}
	 ...
	 */
	@Override
	public LeaveGeneral getLeaveGeneral(long leaveGeneralId)
		throws PortalException, SystemException {
		return leaveGeneralPersistence.findByPrimaryKey(leaveGeneralId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return leaveGeneralPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveGeneral> getLeaveGenerals(int start, int end)
		throws SystemException {
		return leaveGeneralPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveGeneralsCount() throws SystemException {
		return leaveGeneralPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveGeneral updateLeaveGeneral(LeaveGeneral leaveGeneral)
		throws SystemException {
		return leaveGeneralPersistence.update(leaveGeneral);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.LeaveGeneral",
			leaveGeneralLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveGeneralPersistence.getDataSource();
	...
	private LeaveGeneralLocalServiceClpInvoker _clpInvoker = new LeaveGeneralLocalServiceClpInvoker();
}