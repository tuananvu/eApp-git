...
import com.rknowsys.eapp.hrm.service.QualificationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.QualificationLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
...
public abstract class QualificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QualificationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.QualificationLocalServiceUtil} to access the qualification local service.
	 */
	 ...
	 */
	@Override
	public Qualification createQualification(long id) {
		return qualificationPersistence.create(id);
	}
	...
	public Qualification deleteQualification(long id)
		...
		return qualificationPersistence.remove(id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Qualification.class,
	...
	@Override
	public Qualification fetchQualification(long id) throws SystemException {
		return qualificationPersistence.fetchByPrimaryKey(id);
	}
	...
	public Qualification getQualification(long id)
		throws PortalException, SystemException {
		return qualificationPersistence.findByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public int getQualificationsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Qualification",
	...
	private QualificationLocalServiceClpInvoker _clpInvoker = new QualificationLocalServiceClpInvoker();
}