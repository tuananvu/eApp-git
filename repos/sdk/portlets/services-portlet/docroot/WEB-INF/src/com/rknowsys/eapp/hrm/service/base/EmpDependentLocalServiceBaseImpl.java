...
import com.rknowsys.eapp.hrm.service.EmpDependentLocalService;
...
/**
 * Provides the base implementation for the emp dependent local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpDependentLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpDependentLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpDependentLocalServiceUtil
 * @generated
 */
public abstract class EmpDependentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpDependentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpDependentLocalServiceUtil} to access the emp dependent local service.
	 */
	...
	@Override
	public EmpDependent addEmpDependent(EmpDependent empDependent)
		throws SystemException {
		empDependent.setNew(true);

		return empDependentPersistence.update(empDependent);
	}
	 ...
	 */
	@Override
	public EmpDependent createEmpDependent(long empDependentId) {
		return empDependentPersistence.create(empDependentId);
	}
	...
	@Override
	public EmpDependent deleteEmpDependent(long empDependentId)
		throws PortalException, SystemException {
		return empDependentPersistence.remove(empDependentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpDependent deleteEmpDependent(EmpDependent empDependent)
		throws SystemException {
		return empDependentPersistence.remove(empDependent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpDependent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empDependentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empDependentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpDependent fetchEmpDependent(long empDependentId)
		throws SystemException {
		return empDependentPersistence.fetchByPrimaryKey(empDependentId);
	}
	 ...
	 */
	@Override
	public EmpDependent getEmpDependent(long empDependentId)
		throws PortalException, SystemException {
		return empDependentPersistence.findByPrimaryKey(empDependentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empDependentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpDependent> getEmpDependents(int start, int end)
		throws SystemException {
		return empDependentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpDependentsCount() throws SystemException {
		return empDependentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpDependent updateEmpDependent(EmpDependent empDependent)
		throws SystemException {
		return empDependentPersistence.update(empDependent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpDependent",
			empDependentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpDependent");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empDependentPersistence.getDataSource();
	...
	private EmpDependentLocalServiceClpInvoker _clpInvoker = new EmpDependentLocalServiceClpInvoker();
}