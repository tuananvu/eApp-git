...
import com.rknowsys.eapp.hrm.service.SubUnitLocalService;
...
/**
 * Provides the base implementation for the SubUnit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.SubUnitLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.SubUnitLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.SubUnitLocalServiceUtil
 * @generated
 */
public abstract class SubUnitLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SubUnitLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.SubUnitLocalServiceUtil} to access the SubUnit local service.
	 */
	...
	@Override
	public SubUnit addSubUnit(SubUnit subUnit) throws SystemException {
		subUnit.setNew(true);

		return subUnitPersistence.update(subUnit);
	}
	 ...
	 */
	@Override
	public SubUnit createSubUnit(long subUnitId) {
		return subUnitPersistence.create(subUnitId);
	}
	...
	@Override
	public SubUnit deleteSubUnit(long subUnitId)
		throws PortalException, SystemException {
		return subUnitPersistence.remove(subUnitId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SubUnit deleteSubUnit(SubUnit subUnit) throws SystemException {
		return subUnitPersistence.remove(subUnit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SubUnit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return subUnitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return subUnitPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return subUnitPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return subUnitPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return subUnitPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public SubUnit fetchSubUnit(long subUnitId) throws SystemException {
		return subUnitPersistence.fetchByPrimaryKey(subUnitId);
	}
	 ...
	 */
	@Override
	public SubUnit getSubUnit(long subUnitId)
		throws PortalException, SystemException {
		return subUnitPersistence.findByPrimaryKey(subUnitId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return subUnitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SubUnit> getSubUnits(int start, int end)
		throws SystemException {
		return subUnitPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSubUnitsCount() throws SystemException {
		return subUnitPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubUnit updateSubUnit(SubUnit subUnit) throws SystemException {
		return subUnitPersistence.update(subUnit);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.SubUnit",
			subUnitLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = subUnitPersistence.getDataSource();
	...
	private SubUnitLocalServiceClpInvoker _clpInvoker = new SubUnitLocalServiceClpInvoker();
}