...
public class AttachmentLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return AttachmentLocalServiceUtil.addAttachment((com.rknowsys.eapp.hrm.model.Attachment)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return AttachmentLocalServiceUtil.deleteAttachment((com.rknowsys.eapp.hrm.model.Attachment)arguments[0]);
		}
