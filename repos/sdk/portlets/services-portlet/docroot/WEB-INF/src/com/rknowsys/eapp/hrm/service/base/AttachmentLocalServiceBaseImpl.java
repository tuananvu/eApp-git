...
import com.rknowsys.eapp.hrm.service.AttachmentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.AttachmentLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
...
public abstract class AttachmentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.AttachmentLocalServiceUtil} to access the attachment local service.
	 */
	 ...
	 */
	@Override
	public Attachment createAttachment(long id) {
		return attachmentPersistence.create(id);
	}
	...
	public Attachment deleteAttachment(long id)
		...
		return attachmentPersistence.remove(id);
	}
	...
	@Override
	public Attachment fetchAttachment(long id) throws SystemException {
		return attachmentPersistence.fetchByPrimaryKey(id);
	}
	...
	public Attachment getAttachment(long id)
		throws PortalException, SystemException {
		return attachmentPersistence.findByPrimaryKey(id);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Attachment",
