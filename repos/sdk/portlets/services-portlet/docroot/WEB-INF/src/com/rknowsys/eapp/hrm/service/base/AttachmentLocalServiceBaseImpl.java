...
public abstract class AttachmentLocalServiceBaseImpl
	...
	@Override
	public AttachmentFileBlobModel getFileBlobModel(Serializable primaryKey)
		throws SystemException {
		Session session = null;

		try {
			session = attachmentPersistence.openSession();

			return (com.rknowsys.eapp.hrm.model.AttachmentFileBlobModel)session.get(AttachmentFileBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw attachmentPersistence.processException(e);
		}
		finally {
			attachmentPersistence.closeSession(session);
		}
	}
