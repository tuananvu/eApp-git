...
public class LanguagePersistenceImpl extends BasePersistenceImpl<Language>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_EMPLOYEEID =
		new FinderPath(LanguageModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			LanguageModelImpl.EMPLOYEEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_EMPLOYEEID = new FinderPath(LanguageModelImpl.ENTITY_CACHE_ENABLED,
			LanguageModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByemployeeId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the languages where employeeId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<Language> findByemployeeId(long employeeId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the languages where employeeId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.rknowsys.eapp.hrm.model.impl.LanguageModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Language> findByemployeeId(long employeeId, int start, int end)
		throws SystemException {
		return findByemployeeId(employeeId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the languages where employeeId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.rknowsys.eapp.hrm.model.impl.LanguageModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Language> findByemployeeId(long employeeId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Language language : list) {
				if ((employeeId != language.getEmployeeId())) {
					list = null;
	...
	/**
	 * Returns the first language in the ordered set where employeeId = &#63;.
	 *
	 * @param employeeId the employee ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching language
	 ...
	 */
	@Override
	public Language findByemployeeId_First(long employeeId,
		OrderByComparator orderByComparator)
		throws NoSuchLanguageException, SystemException {
		Language language = fetchByemployeeId_First(employeeId,
				orderByComparator);
	 ...
	 */
	@Override
	public Language fetchByemployeeId_First(long employeeId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Language> list = findByemployeeId(employeeId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last language in the ordered set where employeeId = &#63;.
	 *
	 * @param employeeId the employee ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching language
	 ...
	 */
	@Override
	public Language findByemployeeId_Last(long employeeId,
		OrderByComparator orderByComparator)
		throws NoSuchLanguageException, SystemException {
		Language language = fetchByemployeeId_Last(employeeId, orderByComparator);
	 ...
	 */
	@Override
	public Language fetchByemployeeId_Last(long employeeId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Language> list = findByemployeeId(employeeId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the languages before and after the current language in the ordered set where employeeId = &#63;.
	 *
	 * @param languageId the primary key of the current language
	 * @param employeeId the employee ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Language[] findByemployeeId_PrevAndNext(long languageId,
		...
		try {
			...
			array[0] = getByemployeeId_PrevAndNext(session, language,
					employeeId, orderByComparator, true);

			array[1] = language;

			array[2] = getByemployeeId_PrevAndNext(session, language,
	...
	protected Language getByemployeeId_PrevAndNext(Session session,
		Language language, long employeeId,
	...
	/**
	 * Removes all the languages where employeeId = &#63; from the database.
	 *
	 * @param employeeId the employee ID
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByemployeeId(long employeeId) throws SystemException {
		for (Language language : findByemployeeId(employeeId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(language);
		}
	}
	...
	/**
	 * Returns the number of languages where employeeId = &#63;.
	 *
	 * @param employeeId the employee ID
	 * @return the number of matching languages
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_EMPLOYEEID_EMPLOYEEID_2 = "language.employeeId = ?";
	...
	public Language updateImpl(com.rknowsys.eapp.hrm.model.Language language)
		...
		if (isNew || !LanguageModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((languageModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						languageModelImpl.getOriginalEmployeeId()
					};
				...
				args = new Object[] { languageModelImpl.getEmployeeId() };
	...
	protected Language toUnwrappedModel(Language language) {
		...
		languageImpl.setEmployeeId(language.getEmployeeId());
