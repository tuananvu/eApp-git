...
import com.rknowsys.eapp.hrm.service.LeaveRuleApplicableLocalService;
...
/**
 * Provides the base implementation for the leave rule applicable local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LeaveRuleApplicableLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class LeaveRuleApplicableLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveRuleApplicableLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LeaveRuleApplicableLocalServiceUtil} to access the leave rule applicable local service.
	 */
	...
	@Override
	public LeaveRuleApplicable addLeaveRuleApplicable(
		LeaveRuleApplicable leaveRuleApplicable) throws SystemException {
		leaveRuleApplicable.setNew(true);

		return leaveRuleApplicablePersistence.update(leaveRuleApplicable);
	}
	 ...
	 */
	@Override
	public LeaveRuleApplicable createLeaveRuleApplicable(
		long leaveRuleApplicableId) {
		return leaveRuleApplicablePersistence.create(leaveRuleApplicableId);
	}
	...
	@Override
	public LeaveRuleApplicable deleteLeaveRuleApplicable(
		long leaveRuleApplicableId) throws PortalException, SystemException {
		return leaveRuleApplicablePersistence.remove(leaveRuleApplicableId);
	}
	...
	public LeaveRuleApplicable deleteLeaveRuleApplicable(
		LeaveRuleApplicable leaveRuleApplicable) throws SystemException {
		return leaveRuleApplicablePersistence.remove(leaveRuleApplicable);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveRuleApplicable.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return leaveRuleApplicablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveRuleApplicablePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveRuleApplicable fetchLeaveRuleApplicable(
		long leaveRuleApplicableId) throws SystemException {
		return leaveRuleApplicablePersistence.fetchByPrimaryKey(leaveRuleApplicableId);
	}
	 ...
	 */
	@Override
	public LeaveRuleApplicable getLeaveRuleApplicable(
		long leaveRuleApplicableId) throws PortalException, SystemException {
		return leaveRuleApplicablePersistence.findByPrimaryKey(leaveRuleApplicableId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return leaveRuleApplicablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveRuleApplicable> getLeaveRuleApplicables(int start, int end)
		throws SystemException {
		return leaveRuleApplicablePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveRuleApplicablesCount() throws SystemException {
		return leaveRuleApplicablePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveRuleApplicable updateLeaveRuleApplicable(
		LeaveRuleApplicable leaveRuleApplicable) throws SystemException {
		return leaveRuleApplicablePersistence.update(leaveRuleApplicable);
	}
	...
	public void addJobCategoryLeaveRuleApplicable(long jobCategoryId,
		long leaveRuleApplicableId) throws SystemException {
		jobCategoryPersistence.addLeaveRuleApplicable(jobCategoryId,
	...
	public void addJobCategoryLeaveRuleApplicables(long jobCategoryId,
		long[] leaveRuleApplicableIds) throws SystemException {
		jobCategoryPersistence.addLeaveRuleApplicables(jobCategoryId,
	...
	@Override
	public void addJobCategoryLeaveRuleApplicables(long jobCategoryId,
		List<LeaveRuleApplicable> LeaveRuleApplicables)
		throws SystemException {
		jobCategoryPersistence.addLeaveRuleApplicables(jobCategoryId,
	...
	public void clearJobCategoryLeaveRuleApplicables(long jobCategoryId)
		throws SystemException {
		jobCategoryPersistence.clearLeaveRuleApplicables(jobCategoryId);
	}
	...
	public void deleteJobCategoryLeaveRuleApplicable(long jobCategoryId,
		long leaveRuleApplicableId) throws SystemException {
		jobCategoryPersistence.removeLeaveRuleApplicable(jobCategoryId,
			leaveRuleApplicableId);
	}
	...
	public void deleteJobCategoryLeaveRuleApplicables(long jobCategoryId,
		long[] leaveRuleApplicableIds) throws SystemException {
		jobCategoryPersistence.removeLeaveRuleApplicables(jobCategoryId,
			leaveRuleApplicableIds);
	}
	 ...
	 */
	@Override
	public List<LeaveRuleApplicable> getJobCategoryLeaveRuleApplicables(
		long jobCategoryId) throws SystemException {
		return jobCategoryPersistence.getLeaveRuleApplicables(jobCategoryId);
	}
	...
	@Override
	public List<LeaveRuleApplicable> getJobCategoryLeaveRuleApplicables(
		long jobCategoryId, int start, int end) throws SystemException {
		return jobCategoryPersistence.getLeaveRuleApplicables(jobCategoryId,
			start, end);
	}
	...
	public int getJobCategoryLeaveRuleApplicablesCount(long jobCategoryId)
		throws SystemException {
		return jobCategoryPersistence.getLeaveRuleApplicablesSize(jobCategoryId);
	}
	...
	public boolean hasJobCategoryLeaveRuleApplicable(long jobCategoryId,
		long leaveRuleApplicableId) throws SystemException {
		return jobCategoryPersistence.containsLeaveRuleApplicable(jobCategoryId,
			leaveRuleApplicableId);
	}
	...
	public boolean hasJobCategoryLeaveRuleApplicables(long jobCategoryId)
		throws SystemException {
		return jobCategoryPersistence.containsLeaveRuleApplicables(jobCategoryId);
	}
	...
	public void setJobCategoryLeaveRuleApplicables(long jobCategoryId,
		long[] leaveRuleApplicableIds) throws SystemException {
		jobCategoryPersistence.setLeaveRuleApplicables(jobCategoryId,
			leaveRuleApplicableIds);
	}
	...
	public void addJobTitleLeaveRuleApplicable(long jobTitleId,
		long leaveRuleApplicableId) throws SystemException {
		jobTitlePersistence.addLeaveRuleApplicable(jobTitleId,
			leaveRuleApplicableId);
	}
	...
	public void addJobTitleLeaveRuleApplicables(long jobTitleId,
		long[] leaveRuleApplicableIds) throws SystemException {
		jobTitlePersistence.addLeaveRuleApplicables(jobTitleId,
			leaveRuleApplicableIds);
	}
	...
	public void clearJobTitleLeaveRuleApplicables(long jobTitleId)
		throws SystemException {
		jobTitlePersistence.clearLeaveRuleApplicables(jobTitleId);
	}
	...
	public void deleteJobTitleLeaveRuleApplicable(long jobTitleId,
		long leaveRuleApplicableId) throws SystemException {
		jobTitlePersistence.removeLeaveRuleApplicable(jobTitleId,
			leaveRuleApplicableId);
	}
	...
	public void deleteJobTitleLeaveRuleApplicables(long jobTitleId,
		long[] leaveRuleApplicableIds) throws SystemException {
		jobTitlePersistence.removeLeaveRuleApplicables(jobTitleId,
			leaveRuleApplicableIds);
	}
	 ...
	 */
	@Override
	public List<LeaveRuleApplicable> getJobTitleLeaveRuleApplicables(
		long jobTitleId) throws SystemException {
		return jobTitlePersistence.getLeaveRuleApplicables(jobTitleId);
	}
	...
	@Override
	public List<LeaveRuleApplicable> getJobTitleLeaveRuleApplicables(
		long jobTitleId, int start, int end) throws SystemException {
		return jobTitlePersistence.getLeaveRuleApplicables(jobTitleId, start,
			end);
	}
	...
	@Override
	public List<LeaveRuleApplicable> getJobTitleLeaveRuleApplicables(
		long jobTitleId, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		return jobTitlePersistence.getLeaveRuleApplicables(jobTitleId, start,
	...
	public int getJobTitleLeaveRuleApplicablesCount(long jobTitleId)
		throws SystemException {
		return jobTitlePersistence.getLeaveRuleApplicablesSize(jobTitleId);
	}
	...
	public boolean hasJobTitleLeaveRuleApplicable(long jobTitleId,
		long leaveRuleApplicableId) throws SystemException {
		return jobTitlePersistence.containsLeaveRuleApplicable(jobTitleId,
			leaveRuleApplicableId);
	}
	...
	public boolean hasJobTitleLeaveRuleApplicables(long jobTitleId)
		throws SystemException {
		return jobTitlePersistence.containsLeaveRuleApplicables(jobTitleId);
	}
	...
	public void setJobTitleLeaveRuleApplicables(long jobTitleId,
		long[] leaveRuleApplicableIds) throws SystemException {
		jobTitlePersistence.setLeaveRuleApplicables(jobTitleId,
			leaveRuleApplicableIds);
	}
	...
	public void addEmploymentStatusLeaveRuleApplicable(
		...
		throws SystemException {
		employmentStatusPersistence.addLeaveRuleApplicable(employmentStatusId,
			leaveRuleApplicableId);
	}
	...
	@Override
	public void addEmploymentStatusLeaveRuleApplicable(
		long employmentStatusId, LeaveRuleApplicable leaveRuleApplicable)
		throws SystemException {
		employmentStatusPersistence.addLeaveRuleApplicable(employmentStatusId,
			leaveRuleApplicable);
	}
	...
	public void addEmploymentStatusLeaveRuleApplicables(
		...
		throws SystemException {
		employmentStatusPersistence.addLeaveRuleApplicables(employmentStatusId,
			leaveRuleApplicableIds);
	}
	...
	@Override
	public void addEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId, List<LeaveRuleApplicable> LeaveRuleApplicables)
		throws SystemException {
		employmentStatusPersistence.addLeaveRuleApplicables(employmentStatusId,
			LeaveRuleApplicables);
	}
	...
	public void clearEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId) throws SystemException {
		employmentStatusPersistence.clearLeaveRuleApplicables(employmentStatusId);
	}
	...
	public void deleteEmploymentStatusLeaveRuleApplicable(
		long employmentStatusId, long leaveRuleApplicableId)
		throws SystemException {
		employmentStatusPersistence.removeLeaveRuleApplicable(employmentStatusId,
			leaveRuleApplicableId);
	}
	...
	public void deleteEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId, long[] leaveRuleApplicableIds)
		throws SystemException {
		employmentStatusPersistence.removeLeaveRuleApplicables(employmentStatusId,
			leaveRuleApplicableIds);
	}
	 ...
	 */
	@Override
	public List<LeaveRuleApplicable> getEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId) throws SystemException {
		return employmentStatusPersistence.getLeaveRuleApplicables(employmentStatusId);
	}
	...
	@Override
	public List<LeaveRuleApplicable> getEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId, int start, int end) throws SystemException {
		return employmentStatusPersistence.getLeaveRuleApplicables(employmentStatusId,
			start, end);
	}
	...
	public int getEmploymentStatusLeaveRuleApplicablesCount(
		long employmentStatusId) throws SystemException {
		return employmentStatusPersistence.getLeaveRuleApplicablesSize(employmentStatusId);
	}
	...
	public boolean hasEmploymentStatusLeaveRuleApplicable(
		long employmentStatusId, long leaveRuleApplicableId)
		throws SystemException {
		return employmentStatusPersistence.containsLeaveRuleApplicable(employmentStatusId,
			leaveRuleApplicableId);
	}
	...
	public boolean hasEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId) throws SystemException {
		return employmentStatusPersistence.containsLeaveRuleApplicables(employmentStatusId);
	}
	...
	public void setEmploymentStatusLeaveRuleApplicables(
		long employmentStatusId, long[] leaveRuleApplicableIds)
		throws SystemException {
		employmentStatusPersistence.setLeaveRuleApplicables(employmentStatusId,
			leaveRuleApplicableIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.LeaveRuleApplicable",
			leaveRuleApplicableLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveRuleApplicablePersistence.getDataSource();
	...
	private LeaveRuleApplicableLocalServiceClpInvoker _clpInvoker = new LeaveRuleApplicableLocalServiceClpInvoker();
}