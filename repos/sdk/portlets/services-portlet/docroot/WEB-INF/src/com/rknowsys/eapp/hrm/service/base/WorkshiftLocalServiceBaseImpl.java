...
import com.rknowsys.eapp.hrm.service.WorkshiftLocalService;
...
/**
 * Provides the base implementation for the workshift local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.WorkshiftLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.WorkshiftLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.WorkshiftLocalServiceUtil
 * @generated
 */
public abstract class WorkshiftLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements WorkshiftLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.WorkshiftLocalServiceUtil} to access the workshift local service.
	 */
	...
	@Override
	public Workshift addWorkshift(Workshift workshift)
		throws SystemException {
		workshift.setNew(true);

		return workshiftPersistence.update(workshift);
	}
	 ...
	 */
	@Override
	public Workshift createWorkshift(long shiftId) {
		return workshiftPersistence.create(shiftId);
	}
	...
	@Override
	public Workshift deleteWorkshift(long shiftId)
		throws PortalException, SystemException {
		return workshiftPersistence.remove(shiftId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Workshift deleteWorkshift(Workshift workshift)
		throws SystemException {
		return workshiftPersistence.remove(workshift);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Workshift.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return workshiftPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return workshiftPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return workshiftPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Workshift fetchWorkshift(long shiftId) throws SystemException {
		return workshiftPersistence.fetchByPrimaryKey(shiftId);
	}
	 ...
	 */
	@Override
	public Workshift getWorkshift(long shiftId)
		throws PortalException, SystemException {
		return workshiftPersistence.findByPrimaryKey(shiftId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return workshiftPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Workshift> getWorkshifts(int start, int end)
		throws SystemException {
		return workshiftPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getWorkshiftsCount() throws SystemException {
		return workshiftPersistence.countAll();
	}
	...
	public void addEmployeeWorkshift(long employeeId, long shiftId)
		throws SystemException {
		employeePersistence.addWorkshift(employeeId, shiftId);
	}
	 ...
	 */
	@Override
	public void addEmployeeWorkshift(long employeeId, Workshift workshift)
		throws SystemException {
		employeePersistence.addWorkshift(employeeId, workshift);
	}
	...
	public void addEmployeeWorkshifts(long employeeId, long[] shiftIds)
		throws SystemException {
		employeePersistence.addWorkshifts(employeeId, shiftIds);
	}
	...
	public void addEmployeeWorkshifts(long employeeId,
		List<Workshift> Workshifts) throws SystemException {
		employeePersistence.addWorkshifts(employeeId, Workshifts);
	}
	...
	public void clearEmployeeWorkshifts(long employeeId)
		throws SystemException {
		employeePersistence.clearWorkshifts(employeeId);
	}
	...
	public void deleteEmployeeWorkshift(long employeeId, long shiftId)
		throws SystemException {
		employeePersistence.removeWorkshift(employeeId, shiftId);
	}
	 ...
	 */
	@Override
	public void deleteEmployeeWorkshift(long employeeId, Workshift workshift)
		throws SystemException {
		employeePersistence.removeWorkshift(employeeId, workshift);
	}
	...
	public void deleteEmployeeWorkshifts(long employeeId, long[] shiftIds)
		throws SystemException {
		employeePersistence.removeWorkshifts(employeeId, shiftIds);
	}
	...
	public void deleteEmployeeWorkshifts(long employeeId,
		List<Workshift> Workshifts) throws SystemException {
		employeePersistence.removeWorkshifts(employeeId, Workshifts);
	}
	 ...
	 */
	@Override
	public List<Workshift> getEmployeeWorkshifts(long employeeId)
		throws SystemException {
		return employeePersistence.getWorkshifts(employeeId);
	}
	 ...
	 */
	@Override
	public List<Workshift> getEmployeeWorkshifts(long employeeId, int start,
		int end) throws SystemException {
		return employeePersistence.getWorkshifts(employeeId, start, end);
	}
	...
	public int getEmployeeWorkshiftsCount(long employeeId)
		throws SystemException {
		return employeePersistence.getWorkshiftsSize(employeeId);
	}
	...
	public boolean hasEmployeeWorkshift(long employeeId, long shiftId)
		throws SystemException {
		return employeePersistence.containsWorkshift(employeeId, shiftId);
	}
	...
	public boolean hasEmployeeWorkshifts(long employeeId)
		throws SystemException {
		return employeePersistence.containsWorkshifts(employeeId);
	}
	...
	public void setEmployeeWorkshifts(long employeeId, long[] shiftIds)
		throws SystemException {
		employeePersistence.setWorkshifts(employeeId, shiftIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Workshift",
			workshiftLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = workshiftPersistence.getDataSource();
	...
	private WorkshiftLocalServiceClpInvoker _clpInvoker = new WorkshiftLocalServiceClpInvoker();
}