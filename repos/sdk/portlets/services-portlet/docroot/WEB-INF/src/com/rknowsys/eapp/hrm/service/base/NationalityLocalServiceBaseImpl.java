...
import com.rknowsys.eapp.hrm.service.NationalityLocalService;
...
/**
 * Provides the base implementation for the Nationality local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.NationalityLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class NationalityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NationalityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.NationalityLocalServiceUtil} to access the Nationality local service.
	 */
	...
	public Nationality addNationality(Nationality nationality)
		...
		return nationalityPersistence.update(nationality);
	}
	 ...
	 */
	@Override
	public Nationality createNationality(long nationalityId) {
		return nationalityPersistence.create(nationalityId);
	}
	...
	public Nationality deleteNationality(long nationalityId)
		...
		return nationalityPersistence.remove(nationalityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Nationality deleteNationality(Nationality nationality)
		throws SystemException {
		return nationalityPersistence.remove(nationality);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Nationality.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return nationalityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return nationalityPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return nationalityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Nationality fetchNationality(long nationalityId)
		throws SystemException {
		return nationalityPersistence.fetchByPrimaryKey(nationalityId);
	}
	...
	public Nationality getNationality(long nationalityId)
		throws PortalException, SystemException {
		return nationalityPersistence.findByPrimaryKey(nationalityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return nationalityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Nationality> getNationalities(int start, int end)
		throws SystemException {
		return nationalityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getNationalitiesCount() throws SystemException {
		return nationalityPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Nationality",
			nationalityLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.Nationality");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = nationalityPersistence.getDataSource();
	...
	private NationalityLocalServiceClpInvoker _clpInvoker = new NationalityLocalServiceClpInvoker();
}