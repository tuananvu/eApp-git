...
import com.rknowsys.eapp.hrm.service.EmpJobLocalService;
...
/**
 * Provides the base implementation for the emp job local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpJobLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 ...
 * @generated
 */
public abstract class EmpJobLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EmpJobLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpJobLocalServiceUtil} to access the emp job local service.
	 */
	...
	@Override
	public EmpJob addEmpJob(EmpJob empJob) throws SystemException {
		empJob.setNew(true);

		return empJobPersistence.update(empJob);
	}
	 ...
	 */
	@Override
	public EmpJob createEmpJob(long empJobId) {
		return empJobPersistence.create(empJobId);
	}
	...
	@Override
	public EmpJob deleteEmpJob(long empJobId)
		throws PortalException, SystemException {
		return empJobPersistence.remove(empJobId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpJob deleteEmpJob(EmpJob empJob) throws SystemException {
		return empJobPersistence.remove(empJob);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpJob.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return empJobPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return empJobPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empJobPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return empJobPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public EmpJob fetchEmpJob(long empJobId) throws SystemException {
		return empJobPersistence.fetchByPrimaryKey(empJobId);
	}
	 ...
	 */
	@Override
	public EmpJob getEmpJob(long empJobId)
		throws PortalException, SystemException {
		return empJobPersistence.findByPrimaryKey(empJobId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empJobPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpJob> getEmpJobs(int start, int end)
		throws SystemException {
		return empJobPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpJobsCount() throws SystemException {
		return empJobPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpJob updateEmpJob(EmpJob empJob) throws SystemException {
		return empJobPersistence.update(empJob);
	}

	@Override
	public EmpJobContractDetailsBlobModel getContractDetailsBlobModel(
		Serializable primaryKey) throws SystemException {
		Session session = null;

		try {
			session = empJobPersistence.openSession();

			return (com.rknowsys.eapp.hrm.model.EmpJobContractDetailsBlobModel)session.get(EmpJobContractDetailsBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw empJobPersistence.processException(e);
		}
		finally {
			empJobPersistence.closeSession(session);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpJob",
			empJobLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpJob");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empJobPersistence.getDataSource();
	...
	private EmpJobLocalServiceClpInvoker _clpInvoker = new EmpJobLocalServiceClpInvoker();
}