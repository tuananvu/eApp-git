 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmployeeLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmployeeLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmployeeLocalServiceUtil
 * @generated
 */
public abstract class EmployeeLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmployeeLocalServiceUtil} to access the Employee local service.
	 */
	...
	public void addWorkshiftEmployee(long shiftId, long employeeId)
		throws SystemException {
		workshiftPersistence.addEmployee(shiftId, employeeId);
	}
	 ...
	 */
	@Override
	public void addWorkshiftEmployee(long shiftId, Employee employee)
		throws SystemException {
		workshiftPersistence.addEmployee(shiftId, employee);
	}
	...
	public void addWorkshiftEmployees(long shiftId, long[] employeeIds)
		throws SystemException {
		workshiftPersistence.addEmployees(shiftId, employeeIds);
	}
	 ...
	 */
	@Override
	public void addWorkshiftEmployees(long shiftId, List<Employee> Employees)
		throws SystemException {
		workshiftPersistence.addEmployees(shiftId, Employees);
	}
	 ...
	 */
	@Override
	public void clearWorkshiftEmployees(long shiftId) throws SystemException {
		workshiftPersistence.clearEmployees(shiftId);
	}
	...
	public void deleteWorkshiftEmployee(long shiftId, long employeeId)
		throws SystemException {
		workshiftPersistence.removeEmployee(shiftId, employeeId);
	}
	 ...
	 */
	@Override
	public void deleteWorkshiftEmployee(long shiftId, Employee employee)
		throws SystemException {
		workshiftPersistence.removeEmployee(shiftId, employee);
	}
	...
	public void deleteWorkshiftEmployees(long shiftId, long[] employeeIds)
		throws SystemException {
		workshiftPersistence.removeEmployees(shiftId, employeeIds);
	}
	 ...
	 */
	@Override
	public void deleteWorkshiftEmployees(long shiftId, List<Employee> Employees)
		throws SystemException {
		workshiftPersistence.removeEmployees(shiftId, Employees);
	}
	 ...
	 */
	@Override
	public List<Employee> getWorkshiftEmployees(long shiftId)
		throws SystemException {
		return workshiftPersistence.getEmployees(shiftId);
	}
	 ...
	 */
	@Override
	public List<Employee> getWorkshiftEmployees(long shiftId, int start, int end)
		throws SystemException {
		return workshiftPersistence.getEmployees(shiftId, start, end);
	}
	 ...
	 */
	@Override
	public List<Employee> getWorkshiftEmployees(long shiftId, int start,
	...
	public int getWorkshiftEmployeesCount(long shiftId)
		throws SystemException {
		return workshiftPersistence.getEmployeesSize(shiftId);
	}
	...
	public boolean hasWorkshiftEmployee(long shiftId, long employeeId)
		throws SystemException {
		return workshiftPersistence.containsEmployee(shiftId, employeeId);
	}
	...
	public boolean hasWorkshiftEmployees(long shiftId)
		throws SystemException {
		return workshiftPersistence.containsEmployees(shiftId);
	}
	...
	public void setWorkshiftEmployees(long shiftId, long[] employeeIds)
		throws SystemException {
		workshiftPersistence.setEmployees(shiftId, employeeIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Employee",
