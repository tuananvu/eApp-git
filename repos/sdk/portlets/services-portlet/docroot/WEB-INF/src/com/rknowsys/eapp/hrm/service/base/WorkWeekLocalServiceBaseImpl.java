...
import com.rknowsys.eapp.hrm.service.WorkWeekLocalService;
...
/**
 * Provides the base implementation for the WorkWeek local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.WorkWeekLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.WorkWeekLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.WorkWeekLocalServiceUtil
 * @generated
 */
public abstract class WorkWeekLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements WorkWeekLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.WorkWeekLocalServiceUtil} to access the WorkWeek local service.
	 */
	...
	@Override
	public WorkWeek addWorkWeek(WorkWeek workWeek) throws SystemException {
		workWeek.setNew(true);

		return workWeekPersistence.update(workWeek);
	}
	 ...
	 */
	@Override
	public WorkWeek createWorkWeek(long workWeekId) {
		return workWeekPersistence.create(workWeekId);
	}
	...
	@Override
	public WorkWeek deleteWorkWeek(long workWeekId)
		throws PortalException, SystemException {
		return workWeekPersistence.remove(workWeekId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public WorkWeek deleteWorkWeek(WorkWeek workWeek) throws SystemException {
		return workWeekPersistence.remove(workWeek);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WorkWeek.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return workWeekPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return workWeekPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return workWeekPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return workWeekPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public WorkWeek fetchWorkWeek(long workWeekId) throws SystemException {
		return workWeekPersistence.fetchByPrimaryKey(workWeekId);
	}
	 ...
	 */
	@Override
	public WorkWeek getWorkWeek(long workWeekId)
		throws PortalException, SystemException {
		return workWeekPersistence.findByPrimaryKey(workWeekId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return workWeekPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<WorkWeek> getWorkWeeks(int start, int end)
		throws SystemException {
		return workWeekPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getWorkWeeksCount() throws SystemException {
		return workWeekPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public WorkWeek updateWorkWeek(WorkWeek workWeek) throws SystemException {
		return workWeekPersistence.update(workWeek);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.WorkWeek",
			workWeekLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = workWeekPersistence.getDataSource();
	...
	private WorkWeekLocalServiceClpInvoker _clpInvoker = new WorkWeekLocalServiceClpInvoker();
}