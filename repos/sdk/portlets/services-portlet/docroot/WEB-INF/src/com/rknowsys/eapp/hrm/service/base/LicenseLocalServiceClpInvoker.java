...
public class LicenseLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return LicenseLocalServiceUtil.addLicense((com.rknowsys.eapp.hrm.model.License)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return LicenseLocalServiceUtil.deleteLicense((com.rknowsys.eapp.hrm.model.License)arguments[0]);
		}
