...
public class EmpDetailsFinderImpl extends BasePersistenceImpl<EmpDetails>
	...
	/**
	 * This method returns all the employee list from the view table
	 * 'empdetails' based on the given search parameters.
	 * 
	 * @return
	 */
	...
	public List<EmpDetails> findEmpDetails(String empname, String empid,
			...
			String subunit, int begin, int end) {

		System.out.println("Inside findEmpDetails.....");

		System.out.println("params == " + empname + ", " + empid + ", "
				+ empstatus + ", " + supervisorname + ", " + jobtitle + ", "
				+ subunit);

		Session session = null;
		try {
			System.out.println("Inside try block params == " + empname + ", "
					+ empid + ", " + empstatus + ", " + supervisorname + ", "
					+ jobtitle + ", " + subunit);
			...
			if (empname != "" && empname != null) {
				sb.append("CONCAT(firstName,lastName) LIKE '%" + empname
						+ "%' and ");
			}
			if (empid != "" && empid != null) {
			...
			System.out.println("list size == "
					+ QueryUtil.list(q, getDialect(), begin, end).size());
	...
	public List<EmpDetails> findByAll(long employmentStatusId, long titleId, long skillId, String firstName, String empNo, 
			int begin, int end) {
	...
	public static final String FIND_BY_ALL = EmpDetailsFinder.class
			.getName() + ".findByAll";
}