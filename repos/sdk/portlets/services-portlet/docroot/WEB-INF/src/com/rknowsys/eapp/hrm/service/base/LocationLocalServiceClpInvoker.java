...
public class LocationLocalServiceClpInvoker {
	public LocationLocalServiceClpInvoker() {
		...
		_methodName16 = "addHolidayLocation";

		_methodParameterTypes16 = new String[] { "long", "long" };

		_methodName17 = "addHolidayLocation";

		_methodParameterTypes17 = new String[] {
				"long", "com.rknowsys.eapp.hrm.model.Location"
			};

		_methodName18 = "addHolidayLocations";

		_methodParameterTypes18 = new String[] { "long", "long[][]" };

		_methodName19 = "addHolidayLocations";

		_methodParameterTypes19 = new String[] { "long", "java.util.List" };

		_methodName20 = "clearHolidayLocations";

		_methodParameterTypes20 = new String[] { "long" };

		_methodName21 = "deleteHolidayLocation";

		_methodParameterTypes21 = new String[] { "long", "long" };

		_methodName22 = "deleteHolidayLocation";

		_methodParameterTypes22 = new String[] {
				"long", "com.rknowsys.eapp.hrm.model.Location"
			};

		_methodName23 = "deleteHolidayLocations";

		_methodParameterTypes23 = new String[] { "long", "long[][]" };

		_methodName24 = "deleteHolidayLocations";

		_methodParameterTypes24 = new String[] { "long", "java.util.List" };

		_methodName25 = "getHolidayLocations";

		_methodParameterTypes25 = new String[] { "long" };

		_methodName26 = "getHolidayLocations";

		_methodParameterTypes26 = new String[] { "long", "int", "int" };

		_methodName27 = "getHolidayLocations";
		...
		_methodName28 = "getHolidayLocationsCount";

		_methodParameterTypes28 = new String[] { "long" };

		_methodName29 = "hasHolidayLocation";

		_methodParameterTypes29 = new String[] { "long", "long" };

		_methodName30 = "hasHolidayLocations";

		_methodParameterTypes30 = new String[] { "long" };

		_methodName31 = "setHolidayLocations";
		...
		_methodName254 = "findByNationality";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return LocationLocalServiceUtil.addLocation((com.rknowsys.eapp.hrm.model.Location)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return LocationLocalServiceUtil.deleteLocation((com.rknowsys.eapp.hrm.model.Location)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return LocationLocalServiceUtil.updateLocation((com.rknowsys.eapp.hrm.model.Location)arguments[0]);
		}

		if (_methodName16.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes16, parameterTypes)) {
			LocationLocalServiceUtil.addHolidayLocation(((Long)arguments[0]).longValue(),
		...
		if (_methodName17.equals(name) &&
			...
			LocationLocalServiceUtil.addHolidayLocation(((Long)arguments[0]).longValue(),
				(com.rknowsys.eapp.hrm.model.Location)arguments[1]);
		...
		if (_methodName18.equals(name) &&
			...
			LocationLocalServiceUtil.addHolidayLocations(((Long)arguments[0]).longValue(),
				(long[])arguments[1]);
		...
		if (_methodName19.equals(name) &&
			...
			LocationLocalServiceUtil.addHolidayLocations(((Long)arguments[0]).longValue(),
				(java.util.List<com.rknowsys.eapp.hrm.model.Location>)arguments[1]);
		...
		if (_methodName20.equals(name) &&
			...
			LocationLocalServiceUtil.clearHolidayLocations(((Long)arguments[0]).longValue());
		...
		if (_methodName21.equals(name) &&
			...
			LocationLocalServiceUtil.deleteHolidayLocation(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		...
		if (_methodName23.equals(name) &&
			...
			LocationLocalServiceUtil.deleteHolidayLocations(((Long)arguments[0]).longValue(),
				(long[])arguments[1]);
		...
		if (_methodName25.equals(name) &&
			...
			return LocationLocalServiceUtil.getHolidayLocations(((Long)arguments[0]).longValue());
		}
		...
		if (_methodName28.equals(name) &&
			...
			return LocationLocalServiceUtil.getHolidayLocationsCount(((Long)arguments[0]).longValue());
		}

		if (_methodName29.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes29, parameterTypes)) {
			return LocationLocalServiceUtil.hasHolidayLocation(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName30.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes30, parameterTypes)) {
			return LocationLocalServiceUtil.hasHolidayLocations(((Long)arguments[0]).longValue());
		}

		if (_methodName31.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes31, parameterTypes)) {
			LocationLocalServiceUtil.setHolidayLocations(((Long)arguments[0]).longValue(),
				(long[])arguments[1]);
