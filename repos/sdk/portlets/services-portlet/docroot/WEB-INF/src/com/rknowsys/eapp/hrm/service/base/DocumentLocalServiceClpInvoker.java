...
public class DocumentLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DocumentLocalServiceUtil.addDocument((com.rknowsys.eapp.hrm.model.Document)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DocumentLocalServiceUtil.deleteDocument((com.rknowsys.eapp.hrm.model.Document)arguments[0]);
		}
