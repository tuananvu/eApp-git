...
import com.rknowsys.eapp.hrm.service.PayGradeCurrencyLocalService;
...
/**
 * Provides the base implementation for the pay grade currency local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.PayGradeCurrencyLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.PayGradeCurrencyLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.PayGradeCurrencyLocalServiceUtil
 * @generated
 */
public abstract class PayGradeCurrencyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PayGradeCurrencyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.PayGradeCurrencyLocalServiceUtil} to access the pay grade currency local service.
	 */
	...
	@Override
	public PayGradeCurrency addPayGradeCurrency(
		PayGradeCurrency payGradeCurrency) throws SystemException {
		payGradeCurrency.setNew(true);

		return payGradeCurrencyPersistence.update(payGradeCurrency);
	}
	 ...
	 */
	@Override
	public PayGradeCurrency createPayGradeCurrency(long payGradeCurrencyId) {
		return payGradeCurrencyPersistence.create(payGradeCurrencyId);
	}
	...
	@Override
	public PayGradeCurrency deletePayGradeCurrency(long payGradeCurrencyId)
		throws PortalException, SystemException {
		return payGradeCurrencyPersistence.remove(payGradeCurrencyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayGradeCurrency deletePayGradeCurrency(
		PayGradeCurrency payGradeCurrency) throws SystemException {
		return payGradeCurrencyPersistence.remove(payGradeCurrency);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PayGradeCurrency.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return payGradeCurrencyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return payGradeCurrencyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PayGradeCurrency fetchPayGradeCurrency(long payGradeCurrencyId)
		throws SystemException {
		return payGradeCurrencyPersistence.fetchByPrimaryKey(payGradeCurrencyId);
	}
	 ...
	 */
	@Override
	public PayGradeCurrency getPayGradeCurrency(long payGradeCurrencyId)
		throws PortalException, SystemException {
		return payGradeCurrencyPersistence.findByPrimaryKey(payGradeCurrencyId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return payGradeCurrencyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayGradeCurrency> getPayGradeCurrencies(int start, int end)
		throws SystemException {
		return payGradeCurrencyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPayGradeCurrenciesCount() throws SystemException {
		return payGradeCurrencyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayGradeCurrency updatePayGradeCurrency(
		PayGradeCurrency payGradeCurrency) throws SystemException {
		return payGradeCurrencyPersistence.update(payGradeCurrency);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.PayGradeCurrency",
			payGradeCurrencyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.PayGradeCurrency");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = payGradeCurrencyPersistence.getDataSource();
	...
	private PayGradeCurrencyLocalServiceClpInvoker _clpInvoker = new PayGradeCurrencyLocalServiceClpInvoker();
}