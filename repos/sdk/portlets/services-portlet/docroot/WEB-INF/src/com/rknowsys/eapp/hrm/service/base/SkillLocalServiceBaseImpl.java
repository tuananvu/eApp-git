...
import com.rknowsys.eapp.hrm.service.SkillLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.SkillLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.SkillLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.SkillLocalServiceUtil
 * @generated
 */
public abstract class SkillLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SkillLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.SkillLocalServiceUtil} to access the skill local service.
	 */
	...
	@Override
	public Skill addSkill(Skill skill) throws SystemException {
		skill.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Skill deleteSkill(Skill skill) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Skill.class,
	...
	@Override
	public Skill fetchSkill(long skillId) throws SystemException {
	 ...
	 */
	@Override
	public Skill getSkill(long skillId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Skill> getSkills(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getSkillsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Skill updateSkill(Skill skill) throws SystemException {
		return skillPersistence.update(skill);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Skill",
			skillLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.Skill");
	}
	...
	private SkillLocalServiceClpInvoker _clpInvoker = new SkillLocalServiceClpInvoker();
}