...
import com.rknowsys.eapp.hrm.service.HolidayLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.HolidayLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
...
public abstract class HolidayLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements HolidayLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.HolidayLocalServiceUtil} to access the Holiday local service.
	 */
	...
	@Override
	public Holiday addHoliday(Holiday holiday) throws SystemException {
		holiday.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Holiday deleteHoliday(Holiday holiday) throws SystemException {
	...
	@Override
	public Holiday fetchHoliday(long holidayId) throws SystemException {
	 ...
	 */
	@Override
	public int getHolidaiesCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Holiday updateHoliday(Holiday holiday) throws SystemException {
		return holidayPersistence.update(holiday);
	}
	...
	public void addLocationHoliday(long locationId, long holidayId)
		throws SystemException {
		locationPersistence.addHoliday(locationId, holidayId);
	}
	 ...
	 */
	@Override
	public void addLocationHoliday(long locationId, Holiday holiday)
		throws SystemException {
		locationPersistence.addHoliday(locationId, holiday);
	}
	...
	public void addLocationHolidaies(long locationId, long[] holidayIds)
		throws SystemException {
		locationPersistence.addHolidaies(locationId, holidayIds);
	}
	 ...
	 */
	@Override
	public void addLocationHolidaies(long locationId, List<Holiday> Holidaies)
		throws SystemException {
		locationPersistence.addHolidaies(locationId, Holidaies);
	}
	...
	public void clearLocationHolidaies(long locationId)
		throws SystemException {
		locationPersistence.clearHolidaies(locationId);
	}
	...
	public void deleteLocationHoliday(long locationId, long holidayId)
		throws SystemException {
		locationPersistence.removeHoliday(locationId, holidayId);
	}
	 ...
	 */
	@Override
	public void deleteLocationHoliday(long locationId, Holiday holiday)
		throws SystemException {
		locationPersistence.removeHoliday(locationId, holiday);
	}
	...
	public void deleteLocationHolidaies(long locationId, long[] holidayIds)
		throws SystemException {
		locationPersistence.removeHolidaies(locationId, holidayIds);
	}
	 ...
	 */
	@Override
	public void deleteLocationHolidaies(long locationId, List<Holiday> Holidaies)
		throws SystemException {
		locationPersistence.removeHolidaies(locationId, Holidaies);
	}
	 ...
	 */
	@Override
	public List<Holiday> getLocationHolidaies(long locationId)
		throws SystemException {
		return locationPersistence.getHolidaies(locationId);
	}
	 ...
	 */
	@Override
	public List<Holiday> getLocationHolidaies(long locationId, int start,
		int end) throws SystemException {
		return locationPersistence.getHolidaies(locationId, start, end);
	}
	...
	public int getLocationHolidaiesCount(long locationId)
		throws SystemException {
		return locationPersistence.getHolidaiesSize(locationId);
	}
	...
	public boolean hasLocationHoliday(long locationId, long holidayId)
		throws SystemException {
		return locationPersistence.containsHoliday(locationId, holidayId);
	}
	...
	public boolean hasLocationHolidaies(long locationId)
		throws SystemException {
		return locationPersistence.containsHolidaies(locationId);
	}
	...
	public void setLocationHolidaies(long locationId, long[] holidayIds)
		throws SystemException {
		locationPersistence.setHolidaies(locationId, holidayIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Holiday",
			holidayLocalService);
	}
	...
	private HolidayLocalServiceClpInvoker _clpInvoker = new HolidayLocalServiceClpInvoker();
}