...
import com.rknowsys.eapp.hrm.service.PayGradeLocalService;
...
/**
 * Provides the base implementation for the pay grade local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.PayGradeLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.PayGradeLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.PayGradeLocalServiceUtil
 * @generated
 */
public abstract class PayGradeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PayGradeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.PayGradeLocalServiceUtil} to access the pay grade local service.
	 */
	...
	@Override
	public PayGrade addPayGrade(PayGrade payGrade) throws SystemException {
		payGrade.setNew(true);

		return payGradePersistence.update(payGrade);
	}
	 ...
	 */
	@Override
	public PayGrade createPayGrade(long payGradeId) {
		return payGradePersistence.create(payGradeId);
	}
	...
	@Override
	public PayGrade deletePayGrade(long payGradeId)
		throws PortalException, SystemException {
		return payGradePersistence.remove(payGradeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayGrade deletePayGrade(PayGrade payGrade) throws SystemException {
		return payGradePersistence.remove(payGrade);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PayGrade.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return payGradePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return payGradePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return payGradePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return payGradePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PayGrade fetchPayGrade(long payGradeId) throws SystemException {
		return payGradePersistence.fetchByPrimaryKey(payGradeId);
	}
	 ...
	 */
	@Override
	public PayGrade getPayGrade(long payGradeId)
		throws PortalException, SystemException {
		return payGradePersistence.findByPrimaryKey(payGradeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return payGradePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayGrade> getPayGrades(int start, int end)
		throws SystemException {
		return payGradePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPayGradesCount() throws SystemException {
		return payGradePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayGrade updatePayGrade(PayGrade payGrade) throws SystemException {
		return payGradePersistence.update(payGrade);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.PayGrade",
			payGradeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.PayGrade");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = payGradePersistence.getDataSource();
	...
	private PayGradeLocalServiceClpInvoker _clpInvoker = new PayGradeLocalServiceClpInvoker();
}