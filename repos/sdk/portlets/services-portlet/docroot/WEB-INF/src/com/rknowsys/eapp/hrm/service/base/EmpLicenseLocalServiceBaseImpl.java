...
import com.rknowsys.eapp.hrm.service.EmpLicenseLocalService;
...
/**
 * Provides the base implementation for the emp license local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpLicenseLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpLicenseLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpLicenseLocalServiceUtil
 * @generated
 */
public abstract class EmpLicenseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpLicenseLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpLicenseLocalServiceUtil} to access the emp license local service.
	 */
	...
	@Override
	public EmpLicense addEmpLicense(EmpLicense empLicense)
		throws SystemException {
		empLicense.setNew(true);

		return empLicensePersistence.update(empLicense);
	}
	 ...
	 */
	@Override
	public EmpLicense createEmpLicense(long empLicenseId) {
		return empLicensePersistence.create(empLicenseId);
	}
	...
	@Override
	public EmpLicense deleteEmpLicense(long empLicenseId)
		throws PortalException, SystemException {
		return empLicensePersistence.remove(empLicenseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpLicense deleteEmpLicense(EmpLicense empLicense)
		throws SystemException {
		return empLicensePersistence.remove(empLicense);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpLicense.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empLicensePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return empLicensePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empLicensePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpLicense fetchEmpLicense(long empLicenseId)
		throws SystemException {
		return empLicensePersistence.fetchByPrimaryKey(empLicenseId);
	}
	 ...
	 */
	@Override
	public EmpLicense getEmpLicense(long empLicenseId)
		throws PortalException, SystemException {
		return empLicensePersistence.findByPrimaryKey(empLicenseId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empLicensePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpLicense> getEmpLicenses(int start, int end)
		throws SystemException {
		return empLicensePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpLicensesCount() throws SystemException {
		return empLicensePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpLicense updateEmpLicense(EmpLicense empLicense)
		throws SystemException {
		return empLicensePersistence.update(empLicense);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpLicense",
			empLicenseLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empLicensePersistence.getDataSource();
	...
	private EmpLicenseLocalServiceClpInvoker _clpInvoker = new EmpLicenseLocalServiceClpInvoker();
}