...
import com.rknowsys.eapp.hrm.service.EmpSalaryLocalService;
...
/**
 * Provides the base implementation for the emp salary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.EmpSalaryLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.EmpSalaryLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.EmpSalaryLocalServiceUtil
 * @generated
 */
public abstract class EmpSalaryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EmpSalaryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.EmpSalaryLocalServiceUtil} to access the emp salary local service.
	 */
	...
	public EmpSalary addEmpSalary(EmpSalary empSalary)
		...
		return empSalaryPersistence.update(empSalary);
	}
	 ...
	 */
	@Override
	public EmpSalary createEmpSalary(long empSalaryId) {
		return empSalaryPersistence.create(empSalaryId);
	}
	...
	@Override
	public EmpSalary deleteEmpSalary(long empSalaryId)
		throws PortalException, SystemException {
		return empSalaryPersistence.remove(empSalaryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpSalary deleteEmpSalary(EmpSalary empSalary)
		throws SystemException {
		return empSalaryPersistence.remove(empSalary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpSalary.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return empSalaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return empSalaryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return empSalaryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpSalary fetchEmpSalary(long empSalaryId) throws SystemException {
		return empSalaryPersistence.fetchByPrimaryKey(empSalaryId);
	}
	 ...
	 */
	@Override
	public EmpSalary getEmpSalary(long empSalaryId)
		throws PortalException, SystemException {
		return empSalaryPersistence.findByPrimaryKey(empSalaryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return empSalaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpSalary> getEmpSalaries(int start, int end)
		throws SystemException {
		return empSalaryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getEmpSalariesCount() throws SystemException {
		return empSalaryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpSalary updateEmpSalary(EmpSalary empSalary)
		throws SystemException {
		return empSalaryPersistence.update(empSalary);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.EmpSalary",
			empSalaryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.EmpSalary");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = empSalaryPersistence.getDataSource();
	...
	private EmpSalaryLocalServiceClpInvoker _clpInvoker = new EmpSalaryLocalServiceClpInvoker();
}