...
import com.rknowsys.eapp.hrm.service.LocationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LocationLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
...
public abstract class LocationLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LocationLocalServiceUtil} to access the location local service.
	 */
	...
	public void addHolidayLocation(long holidayId, long locationId)
		throws SystemException {
		holidayPersistence.addLocation(holidayId, locationId);
	}
	 ...
	 */
	@Override
	public void addHolidayLocation(long holidayId, Location location)
		throws SystemException {
		holidayPersistence.addLocation(holidayId, location);
	}
	...
	public void addHolidayLocations(long holidayId, long[] locationIds)
		throws SystemException {
		holidayPersistence.addLocations(holidayId, locationIds);
	}
	 ...
	 */
	@Override
	public void addHolidayLocations(long holidayId, List<Location> Locations)
		throws SystemException {
		holidayPersistence.addLocations(holidayId, Locations);
	}
	 ...
	 */
	@Override
	public void clearHolidayLocations(long holidayId) throws SystemException {
		holidayPersistence.clearLocations(holidayId);
	}
	...
	public void deleteHolidayLocation(long holidayId, long locationId)
		throws SystemException {
		holidayPersistence.removeLocation(holidayId, locationId);
	}
	 ...
	 */
	@Override
	public void deleteHolidayLocation(long holidayId, Location location)
		throws SystemException {
		holidayPersistence.removeLocation(holidayId, location);
	}
	...
	public void deleteHolidayLocations(long holidayId, long[] locationIds)
		throws SystemException {
		holidayPersistence.removeLocations(holidayId, locationIds);
	}
	 ...
	 */
	@Override
	public void deleteHolidayLocations(long holidayId, List<Location> Locations)
		throws SystemException {
		holidayPersistence.removeLocations(holidayId, Locations);
	}
	 ...
	 */
	@Override
	public List<Location> getHolidayLocations(long holidayId)
		throws SystemException {
		return holidayPersistence.getLocations(holidayId);
	}
	 ...
	 */
	@Override
	public List<Location> getHolidayLocations(long holidayId, int start, int end)
		throws SystemException {
		return holidayPersistence.getLocations(holidayId, start, end);
	}
	 ...
	 */
	@Override
	public List<Location> getHolidayLocations(long holidayId, int start,
	...
	public int getHolidayLocationsCount(long holidayId)
		throws SystemException {
		return holidayPersistence.getLocationsSize(holidayId);
	}
	...
	public boolean hasHolidayLocation(long holidayId, long locationId)
		throws SystemException {
		return holidayPersistence.containsLocation(holidayId, locationId);
	}
	...
	public boolean hasHolidayLocations(long holidayId)
		throws SystemException {
		return holidayPersistence.containsLocations(holidayId);
	}
	...
	public void setHolidayLocations(long holidayId, long[] locationIds)
		throws SystemException {
		holidayPersistence.setLocations(holidayId, locationIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.Location",
			locationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.rknowsys.eapp.hrm.model.Location");
	}
