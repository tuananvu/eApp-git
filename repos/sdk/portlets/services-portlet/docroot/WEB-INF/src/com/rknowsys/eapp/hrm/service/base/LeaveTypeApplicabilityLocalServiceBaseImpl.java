...
import com.rknowsys.eapp.hrm.service.LeaveTypeApplicabilityLocalService;
...
/**
 * Provides the base implementation for the leave type applicability local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.rknowsys.eapp.hrm.service.impl.LeaveTypeApplicabilityLocalServiceImpl}.
 * </p>
 *
 * @author rknowsys
 * @see com.rknowsys.eapp.hrm.service.impl.LeaveTypeApplicabilityLocalServiceImpl
 * @see com.rknowsys.eapp.hrm.service.LeaveTypeApplicabilityLocalServiceUtil
 * @generated
 */
public abstract class LeaveTypeApplicabilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveTypeApplicabilityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.rknowsys.eapp.hrm.service.LeaveTypeApplicabilityLocalServiceUtil} to access the leave type applicability local service.
	 */
	...
	@Override
	public LeaveTypeApplicability addLeaveTypeApplicability(
		LeaveTypeApplicability leaveTypeApplicability)
		throws SystemException {
		leaveTypeApplicability.setNew(true);

		return leaveTypeApplicabilityPersistence.update(leaveTypeApplicability);
	}
	 ...
	 */
	@Override
	public LeaveTypeApplicability createLeaveTypeApplicability(
		long leaveTypeApplicabilityId) {
		return leaveTypeApplicabilityPersistence.create(leaveTypeApplicabilityId);
	}
	...
	@Override
	public LeaveTypeApplicability deleteLeaveTypeApplicability(
		long leaveTypeApplicabilityId) throws PortalException, SystemException {
		return leaveTypeApplicabilityPersistence.remove(leaveTypeApplicabilityId);
	}
	...
	public LeaveTypeApplicability deleteLeaveTypeApplicability(
		LeaveTypeApplicability leaveTypeApplicability)
		throws SystemException {
		return leaveTypeApplicabilityPersistence.remove(leaveTypeApplicability);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveTypeApplicability.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveTypeApplicabilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return leaveTypeApplicabilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveTypeApplicability fetchLeaveTypeApplicability(
		long leaveTypeApplicabilityId) throws SystemException {
		return leaveTypeApplicabilityPersistence.fetchByPrimaryKey(leaveTypeApplicabilityId);
	}
	 ...
	 */
	@Override
	public LeaveTypeApplicability getLeaveTypeApplicability(
		long leaveTypeApplicabilityId) throws PortalException, SystemException {
		return leaveTypeApplicabilityPersistence.findByPrimaryKey(leaveTypeApplicabilityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return leaveTypeApplicabilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveTypeApplicability> getLeaveTypeApplicabilities(int start,
		int end) throws SystemException {
		return leaveTypeApplicabilityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLeaveTypeApplicabilitiesCount() throws SystemException {
		return leaveTypeApplicabilityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveTypeApplicability updateLeaveTypeApplicability(
		LeaveTypeApplicability leaveTypeApplicability)
		throws SystemException {
		return leaveTypeApplicabilityPersistence.update(leaveTypeApplicability);
	}
	...
	public void addJobTitleLeaveTypeApplicability(long jobTitleId,
		long leaveTypeApplicabilityId) throws SystemException {
		jobTitlePersistence.addLeaveTypeApplicability(jobTitleId,
	...
	public void addJobTitleLeaveTypeApplicabilities(long jobTitleId,
		long[] leaveTypeApplicabilityIds) throws SystemException {
		jobTitlePersistence.addLeaveTypeApplicabilities(jobTitleId,
	...
	public void clearJobTitleLeaveTypeApplicabilities(long jobTitleId)
		throws SystemException {
		jobTitlePersistence.clearLeaveTypeApplicabilities(jobTitleId);
	}
	...
	public void deleteJobTitleLeaveTypeApplicability(long jobTitleId,
		long leaveTypeApplicabilityId) throws SystemException {
		jobTitlePersistence.removeLeaveTypeApplicability(jobTitleId,
			leaveTypeApplicabilityId);
	}
	...
	public void deleteJobTitleLeaveTypeApplicabilities(long jobTitleId,
		long[] leaveTypeApplicabilityIds) throws SystemException {
		jobTitlePersistence.removeLeaveTypeApplicabilities(jobTitleId,
			leaveTypeApplicabilityIds);
	}
	 ...
	 */
	@Override
	public List<LeaveTypeApplicability> getJobTitleLeaveTypeApplicabilities(
		long jobTitleId) throws SystemException {
		return jobTitlePersistence.getLeaveTypeApplicabilities(jobTitleId);
	}
	...
	public int getJobTitleLeaveTypeApplicabilitiesCount(long jobTitleId)
		throws SystemException {
		return jobTitlePersistence.getLeaveTypeApplicabilitiesSize(jobTitleId);
	}
	...
	public boolean hasJobTitleLeaveTypeApplicability(long jobTitleId,
		long leaveTypeApplicabilityId) throws SystemException {
		return jobTitlePersistence.containsLeaveTypeApplicability(jobTitleId,
			leaveTypeApplicabilityId);
	}
	...
	public boolean hasJobTitleLeaveTypeApplicabilities(long jobTitleId)
		throws SystemException {
		return jobTitlePersistence.containsLeaveTypeApplicabilities(jobTitleId);
	}
	...
	public void setJobTitleLeaveTypeApplicabilities(long jobTitleId,
		long[] leaveTypeApplicabilityIds) throws SystemException {
		jobTitlePersistence.setLeaveTypeApplicabilities(jobTitleId,
			leaveTypeApplicabilityIds);
	}
	...
	public void addEmploymentStatusLeaveTypeApplicability(
		...
		throws SystemException {
		employmentStatusPersistence.addLeaveTypeApplicability(employmentStatusId,
			leaveTypeApplicabilityId);
	}
	...
	@Override
	public void addEmploymentStatusLeaveTypeApplicability(
		long employmentStatusId, LeaveTypeApplicability leaveTypeApplicability)
		throws SystemException {
		employmentStatusPersistence.addLeaveTypeApplicability(employmentStatusId,
			leaveTypeApplicability);
	}
	...
	public void addEmploymentStatusLeaveTypeApplicabilities(
		...
		throws SystemException {
		employmentStatusPersistence.addLeaveTypeApplicabilities(employmentStatusId,
			leaveTypeApplicabilityIds);
	}
	...
	public void clearEmploymentStatusLeaveTypeApplicabilities(
		...
		employmentStatusPersistence.clearLeaveTypeApplicabilities(employmentStatusId);
	}
	...
	public void deleteEmploymentStatusLeaveTypeApplicability(
		long employmentStatusId, long leaveTypeApplicabilityId)
		throws SystemException {
		employmentStatusPersistence.removeLeaveTypeApplicability(employmentStatusId,
			leaveTypeApplicabilityId);
	}
	...
	public void deleteEmploymentStatusLeaveTypeApplicabilities(
		long employmentStatusId, long[] leaveTypeApplicabilityIds)
		throws SystemException {
		employmentStatusPersistence.removeLeaveTypeApplicabilities(employmentStatusId,
			leaveTypeApplicabilityIds);
	}
	 ...
	 */
	@Override
	public List<LeaveTypeApplicability> getEmploymentStatusLeaveTypeApplicabilities(
		long employmentStatusId) throws SystemException {
		return employmentStatusPersistence.getLeaveTypeApplicabilities(employmentStatusId);
	}
	...
	public int getEmploymentStatusLeaveTypeApplicabilitiesCount(
		long employmentStatusId) throws SystemException {
		return employmentStatusPersistence.getLeaveTypeApplicabilitiesSize(employmentStatusId);
	}
	...
	public boolean hasEmploymentStatusLeaveTypeApplicability(
		long employmentStatusId, long leaveTypeApplicabilityId)
		throws SystemException {
		return employmentStatusPersistence.containsLeaveTypeApplicability(employmentStatusId,
			leaveTypeApplicabilityId);
	}
	...
	public boolean hasEmploymentStatusLeaveTypeApplicabilities(
		long employmentStatusId) throws SystemException {
		return employmentStatusPersistence.containsLeaveTypeApplicabilities(employmentStatusId);
	}
	...
	public void setEmploymentStatusLeaveTypeApplicabilities(
		long employmentStatusId, long[] leaveTypeApplicabilityIds)
		throws SystemException {
		employmentStatusPersistence.setLeaveTypeApplicabilities(employmentStatusId,
			leaveTypeApplicabilityIds);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rknowsys.eapp.hrm.model.LeaveTypeApplicability",
			leaveTypeApplicabilityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = leaveTypeApplicabilityPersistence.getDataSource();
	...
	private LeaveTypeApplicabilityLocalServiceClpInvoker _clpInvoker = new LeaveTypeApplicabilityLocalServiceClpInvoker();
}