...
public class NewsLocalServiceClp implements NewsLocalService {
	public NewsLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.rknowsys.eapp.hrm.model.News addNews(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(news) });
		}
		catch (Throwable t) {
		...
		return (com.rknowsys.eapp.hrm.model.News)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.rknowsys.eapp.hrm.model.News> getNewses(
		...
		return (java.util.List<com.rknowsys.eapp.hrm.model.News>)ClpSerializer.translateOutput(returnObj);
	}
