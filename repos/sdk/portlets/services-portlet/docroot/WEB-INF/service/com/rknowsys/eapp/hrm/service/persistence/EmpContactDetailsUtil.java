...
/**
 * The persistence utility for the EmpContactDetails service. This utility wraps {@link EmpContactDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class EmpContactDetailsUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(EmpContactDetails empContactDetails) {
		getPersistence().clearCache(empContactDetails);
	}
	 ...
	 */
	public static List<EmpContactDetails> findWithDynamicQuery(
	 ...
	 */
	public static EmpContactDetails update(EmpContactDetails empContactDetails)
		throws SystemException {
		return getPersistence().update(empContactDetails);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static EmpContactDetails update(
		EmpContactDetails empContactDetails, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(empContactDetails, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(empContactDetails);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(empContactDetailses);
	}
	...
	*/
	public static com.rknowsys.eapp.hrm.model.EmpContactDetails create(
		long empContactDetailsId) {
		return getPersistence().create(empContactDetailsId);
	}
	...
	*/
	public static com.rknowsys.eapp.hrm.model.EmpContactDetails remove(
		long empContactDetailsId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rknowsys.eapp.hrm.NoSuchEmpContactDetailsException {
		return getPersistence().remove(empContactDetailsId);
	}

	public static com.rknowsys.eapp.hrm.model.EmpContactDetails updateImpl(
		com.rknowsys.eapp.hrm.model.EmpContactDetails empContactDetails)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(empContactDetails);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.EmpContactDetails findByPrimaryKey(
		long empContactDetailsId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.rknowsys.eapp.hrm.NoSuchEmpContactDetailsException {
		return getPersistence().findByPrimaryKey(empContactDetailsId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.EmpContactDetails fetchByPrimaryKey(
		long empContactDetailsId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(empContactDetailsId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rknowsys.eapp.hrm.model.EmpContactDetails> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EmpContactDetailsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EmpContactDetailsPersistence)PortletBeanLocatorUtil.locate(com.rknowsys.eapp.hrm.service.ClpSerializer.getServletContextName(),
					EmpContactDetailsPersistence.class.getName());

			ReferenceRegistry.registerReference(EmpContactDetailsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(EmpContactDetailsPersistence persistence) {
	}

	private static EmpContactDetailsPersistence _persistence;
}