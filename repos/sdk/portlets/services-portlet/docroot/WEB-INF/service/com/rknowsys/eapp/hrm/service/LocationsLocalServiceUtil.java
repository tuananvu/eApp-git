 ...
 * {@link com.rknowsys.eapp.hrm.service.impl.LocationsLocalServiceImpl} and is the
 ...
 * @see com.rknowsys.eapp.hrm.service.base.LocationsLocalServiceBaseImpl
...
public class LocationsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.LocationsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.rknowsys.eapp.hrm.model.Locations addLocations(
	...
	*/
	public static com.rknowsys.eapp.hrm.model.Locations createLocations(long id) {
		return getService().createLocations(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.Locations deleteLocations(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteLocations(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.Locations deleteLocations(
		com.rknowsys.eapp.hrm.model.Locations locations)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.rknowsys.eapp.hrm.model.Locations fetchLocations(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchLocations(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.Locations getLocations(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getLocations(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.rknowsys.eapp.hrm.model.Locations> getLocationses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.rknowsys.eapp.hrm.model.Locations updateLocations(
		com.rknowsys.eapp.hrm.model.Locations locations)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LocationsLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					LocationsLocalService.class.getName());

			if (invokableLocalService instanceof LocationsLocalService) {
				_service = (LocationsLocalService)invokableLocalService;
			}
			else {
				_service = new LocationsLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(LocationsLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(LocationsLocalService service) {
	}

	private static LocationsLocalService _service;
}