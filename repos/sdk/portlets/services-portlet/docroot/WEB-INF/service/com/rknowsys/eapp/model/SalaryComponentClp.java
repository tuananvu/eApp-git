...
import com.rknowsys.eapp.service.ClpSerializer;
import com.rknowsys.eapp.service.SalaryComponentLocalServiceUtil;
...
public class SalaryComponentClp extends BaseModelImpl<SalaryComponent>
	...
	public void setId(long id) {
		...
		if (_salaryComponentRemoteModel != null) {
			try {
				...
				method.invoke(_salaryComponentRemoteModel, id);
			}
			catch (Exception e) {
	...
	public String toXmlString() {
		...
		sb.append("com.rknowsys.eapp.model.SalaryComponent");
