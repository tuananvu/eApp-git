...
/**
 * Provides the local service interface for PayGrade. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rknowsys
 * @see PayGradeLocalServiceUtil
...
public interface PayGradeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PayGradeLocalServiceUtil} to access the pay grade local service. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.PayGradeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
