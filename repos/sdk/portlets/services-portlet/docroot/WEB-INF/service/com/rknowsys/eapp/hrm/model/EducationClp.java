	...
	public void setGroupId(long groupId) {
		...
		if (_educationRemoteModel != null) {
			try {
				...
				method.invoke(_educationRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setEduLevel(String eduLevel) {
		...
		if (_educationRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setEduLevel", String.class);

				method.invoke(_educationRemoteModel, eduLevel);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
