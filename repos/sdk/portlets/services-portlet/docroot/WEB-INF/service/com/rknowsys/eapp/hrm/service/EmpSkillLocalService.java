...
/**
 * Provides the local service interface for EmpSkill. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rknowsys
 * @see EmpSkillLocalServiceUtil
...
public interface EmpSkillLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpSkillLocalServiceUtil} to access the emp skill local service. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.EmpSkillLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
