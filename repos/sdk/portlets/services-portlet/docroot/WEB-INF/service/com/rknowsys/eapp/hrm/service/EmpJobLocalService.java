...
/**
 * Provides the local service interface for EmpJob. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rknowsys
 * @see EmpJobLocalServiceUtil
...
public interface EmpJobLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpJobLocalServiceUtil} to access the emp job local service. Add custom service methods to {@link com.rknowsys.eapp.hrm.service.impl.EmpJobLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
