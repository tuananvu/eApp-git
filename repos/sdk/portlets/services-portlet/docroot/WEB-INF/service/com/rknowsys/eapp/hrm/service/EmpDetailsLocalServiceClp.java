 ...
 * @generated
 */
public class EmpDetailsLocalServiceClp implements EmpDetailsLocalService {
	public EmpDetailsLocalServiceClp(
	...
	public com.rknowsys.eapp.hrm.model.EmpDetails addEmpDetails(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(empDetails) });
		}
		catch (Throwable t) {
		...
		return (com.rknowsys.eapp.hrm.model.EmpDetails)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.rknowsys.eapp.hrm.model.EmpDetails createEmpDetails(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { empdetailsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.rknowsys.eapp.hrm.model.EmpDetails deleteEmpDetails(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { empdetailsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.rknowsys.eapp.hrm.model.EmpDetails fetchEmpDetails(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { empdetailsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.rknowsys.eapp.hrm.model.EmpDetails getEmpDetails(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { empdetailsId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.rknowsys.eapp.hrm.model.EmpDetails> findEmpDetails(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] {
						ClpSerializer.translateInput(empname),
						
					ClpSerializer.translateInput(empid),
						
					ClpSerializer.translateInput(empstatus),
						
					ClpSerializer.translateInput(supervisorname),
	...
	public java.util.List findByAll(long employmentStatusId, long titleId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					ClpSerializer.translateInput(empNo),
