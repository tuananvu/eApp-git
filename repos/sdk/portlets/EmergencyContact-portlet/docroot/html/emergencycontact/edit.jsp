...
EmergencyContact j = (EmergencyContact)rslt.getObject();

String prk=String.valueOf(j.getPrimaryKey());
System.out.println("in edit.jsp, prk="+prk);
%>
<liferay-ui:icon-menu>
<portlet:actionURL var="editemergencycontact" name="editEmergencyContact">
<portlet:param name="emergencycontactId" value="<%=prk %>"/>
</portlet:actionURL>


<a href="#" onclick="window.location='<%=editemergencycontact.toString()%>'"><img
