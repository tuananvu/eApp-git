...
<portlet:renderURL var="listview">
	<portlet:param name="mvcPath" value="/html/membershipaction/add.jsp" />
</portlet:renderURL>
<style type="text/css">
.table-first-header {
	width: 10%;
...
iteratorURL.setParameter("mvcPath", "/html/membershipaction/add.jsp");
 ...
 %>
	...
	<liferay-ui:search-container-row className="Membership"
		...
		<liferay-ui:search-container-column-jsp name="Edit"
			path="/html/membershipaction/editClick.jsp" />
