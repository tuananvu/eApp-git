...
<div id="editjobadddelete" class="span12">
  ...
  <aui:form name="myForm" action="<%=savejobcategory.toString()%>">
		<aui:input name="jobcategoryId" type="hidden" id="jobcategoryId"  value="<%=editjobcategory.getId()%>"/>
		<div class="span12">
				<div class="span2">
...
iteratorURL.setParameter("mvcPath", "/html/jobcategory/editjobcategory.jsp");
...
<liferay-ui:search-container orderByCol="<%=sortByCol %>" orderByType="<%=sortByType %>" rowChecker="<%= new RowChecker(renderResponse) %>"  delta="5" emptyResultsMessage="No records is available for Jobcategory"   deltaConfigurable="true"   iteratorURL="<%=iteratorURL%>">
 ...
 %>
	...
	<liferay-ui:search-container-row className="JobCategory" keyProperty="id" modelVar="JobCategory"  rowVar="curRow" escapedModel="<%= true %>">
		 ...
		 <liferay-ui:search-container-column-jsp name="Edit"  path="/html/jobcategory/edit.jsp"/>
